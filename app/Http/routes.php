...
Route::get('/docs/api/id/34', 'CopyController@autoNavi');
Route::get('/docs/api/id/34/aid/78', 'CopyController@autoNavi');
Route::get('/docs/api/id/34/aid/674', 'CopyController@autoNavi');
Route::get('/docs/api/id/226', 'CopyController@autoNavi');
...
Route::get('/docs/api/id/63', 'CopyController@autoNavi');
Route::get('/docs/api/id/28/aid/57', 'CopyController@autoNavi');
Route::get('/docs/api/id/28/aid/58', 'CopyController@autoNavi');
Route::get('/docs/api/id/80/aid/204', 'CopyController@autoNavi');
Route::get('/docs/api/id/80/aid/205', 'CopyController@autoNavi');
Route::get('/docs/api/id/213', 'CopyController@autoNavi');
Route::get('/docs/api/id/27', 'CopyController@autoNavi');
