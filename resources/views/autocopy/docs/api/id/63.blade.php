...
<head>
<meta charset="utf-8">
<meta name="keywords" content="历史上的今天数据接口,API数据调用" />
...
<title>历史上的今天数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a63.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>历史上的今天</strong>
                                                <span class="h1_span color_juhe">分享数据</span>
                        
                        <span class="h1_span color_mianfei">免费</span>                                                
                                            </h2>
                    <p class="doc_api_decsP">回顾历史的长河，历史是生活的一面镜子</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">63</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">4512</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请历史上的今天 API" data="/myData/apply/id/63">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/63" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="63"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/63" title="事件列表(v1.0)">1.事件列表(v1.0)</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/63/aid/180" title="根据ID查询事件详情(v1.0)">2.根据ID查询事件详情(v1.0)</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/63/aid/849" title="事件列表(v2.0推荐)">3.事件列表(v2.0推荐)</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/63/aid/850" title="根据id查询详细信息(v2.0推荐)">4.根据id查询详细信息(v2.0推荐)</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://api.juheapi.com/japi/toh</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://api.juheapi.com/japi/toh?key=您申请的KEY&amp;v=1.0&amp;month=11&amp;day=1</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">查看某月某日的事件列表</font></div>
                        ...
                        <div class="simpleline simpleTable">
                            ...
                            <div class="prediv">
                                <pre>{
    &quot;error_code&quot;: 0, <font color='red'>/*返回码*/</font>
    &quot;reason&quot;: &quot;请求成功！&quot;,
    &quot;result&quot;: [
        {
            &quot;day&quot;: 1,  <font color='red'>/*日*/</font>
            &quot;des&quot;: &quot;1907年11月1日 电影导演吴永刚诞生 　　吴永刚，1907年11月1日生于江苏吴县。1932年后参加影片《三个摩登女性》、《母性之光》的拍摄工作。1934年在联华影片公司编导处女作《神女》，一举成名，...&quot;,  <font color='red'>/*描述*/</font>
            &quot;id&quot;: 9000,  <font color='red'>/*事件ID*/</font>
            &quot;lunar&quot;: &quot;丁未年九月廿六&quot;,
            &quot;month&quot;: 11,  <font color='red'>/*月份*/</font>
            &quot;pic&quot;: &quot;&quot;,  <font color='red'>/*图片*/</font>
            &quot;title&quot;: &quot;电影导演吴永刚诞生&quot;,  <font color='red'>/*事件标题*/</font>
            &quot;year&quot;: 1907  <font color='red'>/*年份*/</font>
        },
        {
            &quot;day&quot;: 1,
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">10019</td>
                                <td class="text">错误的版本号</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">206301</td>
                                <td class="text">错误的请求参数</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">206302</td>
                                <td class="text">无相关数据</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>时间</th>
                                                        ...
                                                        <tr>
                                <td>&nbsp;</td>
                                <td><a href="/news/index/id/91" target="_blank">历史上的今天API发布啦！</a></td>
                                <td class="url">2014-09-10 15:17:21</td>
                            </tr>
                                                    </table>
                    </div>
                </div> -->
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/60"><img src="/themes/images/data/new/a60.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/60">验证码识别</a></p>
                    <p class="apides">根据图片识别验证码，支持数字、字母组合</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/18"><img src="/themes/images/data/new/a18.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/18">全国WIFI</a></p>
                    <p class="apides">全国免费的WIFI热点分布</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/50"><img src="/themes/images/data/new/a50.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/50">图书电商数据</a></p>
                    <p class="apides">于万千之中选择你所爱--好书推荐，值得你信赖。</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/47"><img src="/themes/images/data/new/a47.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/47">地产数据</a></p>
                    <p class="apides">全国地产数据，目前已经包含深圳、苏州、上海等城市，其他城市陆续添加中</p>
                </li>
                            </ul>
