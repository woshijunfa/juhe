...
<head>
<meta charset="utf-8">
<meta name="keywords" content="企业工商信息数据接口,API数据调用" />
...
<title>企业工商信息数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a192.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>企业工商信息</strong>
                                                <span class="h1_span color_disanfang">启信宝</span>
                        
                                                                        
                                            </h2>
                    <p class="doc_api_decsP">根据企业名称或营业执照编号查询企业基本工商信息。</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">192</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">755</font></p>
                            <p><b>接入服务商：</b><font color="#03c5ff">启信宝</font></p>
                        </div>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请企业工商信息 API" data="/myData/apply/id/192">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/192" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="192"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/192" title="企业列表查询">1.企业列表查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/192/aid/689" title="根据全名或注册号精确查询">2.根据全名或注册号精确查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/192/aid/690" title="根据企业id获取详细信息">3.根据企业id获取详细信息</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/192/aid/702" title="测试接口(免费)">4.测试接口(免费)</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://japi.juhe.cn/enterprise/searchList</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://japi.juhe.cn/enterprise/searchList?keyword=新科兰德&amp;key=您申请的KEY&amp;skip=3</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">根据企业名称或者企业注册号获取企业列表</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/192" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>企业编号</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">start_date</td>
                                    <td class="url">string</td>
                                    <td>成立日期</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">oper_name</td>
                                    <td class="url">string</td>
                                    <td>企业法人</td>
                                  </tr>
                                                              </table>
    ...
    &quot;result&quot;: {
        &quot;data&quot;: {
            ...
            &quot;items&quot;: [
                {
                    &quot;name&quot;: &quot;乌鲁木齐德兰特新材料科技有限责任公司&quot;,
                    &quot;id&quot;: &quot;265c0886-5398-4ff0-8480-b5d03acba9f8&quot;,
                    &quot;start_date&quot;: &quot;2015-05-21&quot;,
                    &quot;oper_name&quot;: &quot;康雪雅&quot;
                },
                {
                    &quot;name&quot;: &quot;陕西厚兰德新能源科技有限公司&quot;,
                    &quot;id&quot;: &quot;a09273dc-28ff-4e38-a94d-e5b2bad3e6d5&quot;,
                    &quot;start_date&quot;: &quot;2015-05-14&quot;,
                    &quot;oper_name&quot;: &quot;兰飞&quot;
                },
                {
                    &quot;name&quot;: &quot;新疆德若兰纺织科技有限公司&quot;,
                    &quot;id&quot;: &quot;8e106927-c09d-40a4-ae96-2b2075e86321&quot;,
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">219201</td>
                                <td class="text">查询无结果</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">219205</td>
                                <td class="text">超过最大查询数量</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">219207</td>
                                <td class="text">查询错误，请联系技术人员</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">219208</td>
                                <td class="text">参数名错误或参数为空</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">219209</td>
                                <td class="text">接口查询异常，请联系技术人员</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/192" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
