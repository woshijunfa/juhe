...
<head>
<meta charset="utf-8">
<meta name="keywords" content="全国天气预报数据接口,API数据调用" />
...
<title>全国天气预报数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a39.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">39</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">40142</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/39" target="_blank">离线文档</a> -->
                                  ...
                                  <a class="unfavit" id="favita" data="39"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/39" title="根据城市名/id查询天气">1.根据城市名/id查询天气</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/39/aid/117" title="天气种类及标识列表">2.天气种类及标识列表</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/39/aid/132" title="根据IP查询天气">3.根据IP查询天气</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/39/aid/133" title="根据GPS坐标查询天气">4.根据GPS坐标查询天气</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/39/aid/134" title="城市天气三小时预报">5.城市天气三小时预报</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/39/aid/167" title="支持城市列表">6.支持城市列表</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/weather/index</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/weather/index?format=2&amp;cityname=%E8%8B%8F%E5%B7%9E&amp;key=您申请的KEY</span></div>

                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/39" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">int</td>
                                    <td class="url">N</td>
                                    <td>未来6天预报(future)两种返回格式，1或2，默认1</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">key</td>
    ...
    &quot;reason&quot;: &quot;查询成功!&quot;,
    &quot;result&quot;: {
        &quot;sk&quot;: {	<font color='red'>/*当前实况天气*/</font>
            &quot;temp&quot;: &quot;21&quot;,	<font color='red'>/*当前温度*/</font>
            &quot;wind_direction&quot;: &quot;西风&quot;,	<font color='red'>/*当前风向*/</font>
            &quot;wind_strength&quot;: &quot;2级&quot;,	<font color='red'>/*当前风力*/</font>	
            &quot;humidity&quot;: &quot;4%&quot;,	<font color='red'>/*当前湿度*/</font>
            &quot;time&quot;: &quot;14:25&quot;	<font color='red'>/*更新时间*/</font>
        },
        &quot;today&quot;: {
            &quot;city&quot;: &quot;天津&quot;,
            &quot;date_y&quot;: &quot;2014年03月21日&quot;,
            &quot;week&quot;: &quot;星期五&quot;,
            &quot;temperature&quot;: &quot;8℃~20℃&quot;,	<font color='red'>/*今日温度*/</font>
            &quot;weather&quot;: &quot;晴转霾&quot;,	<font color='red'>/*今日天气*/</font>
            &quot;weather_id&quot;: {	<font color='red'>/*天气唯一标识*/</font>
                &quot;fa&quot;: &quot;00&quot;,	<font color='red'>/*天气标识00：晴*/</font>
                &quot;fb&quot;: &quot;53&quot;	<font color='red'>/*天气标识53：霾 如果fa不等于fb，说明是组合天气*/</font>
            },
            &quot;wind&quot;: &quot;西南风微风&quot;,
            &quot;dressing_index&quot;: &quot;较冷&quot;, <font color='red'>/*穿衣指数*/</font>
            &quot;dressing_advice&quot;: &quot;建议着大衣、呢外套加毛衣、卫衣等服装。&quot;,	<font color='red'>/*穿衣建议*/</font>
            &quot;uv_index&quot;: &quot;中等&quot;,	<font color='red'>/*紫外线强度*/</font>
            &quot;comfort_index&quot;: &quot;&quot;,<font color='red'>/*舒适度指数*/</font>
            &quot;wash_index&quot;: &quot;较适宜&quot;,	<font color='red'>/*洗车指数*/</font>
            &quot;travel_index&quot;: &quot;适宜&quot;,	<font color='red'>/*旅游指数*/</font>
            &quot;exercise_index&quot;: &quot;较适宜&quot;,	<font color='red'>/*晨练指数*/</font>
            &quot;drying_index&quot;: &quot;&quot;<font color='red'>/*干燥指数*/</font>
        },
        &quot;future&quot;: [	<font color='red'>/*未来几天天气*/</font>
            {
                &quot;temperature&quot;: &quot;28℃~36℃&quot;,
                &quot;weather&quot;: &quot;晴转多云&quot;,
                &quot;weather_id&quot;: {
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">203901</td>
                                <td class="text">查询城市不能为空</td>
                                <!--<td class="url">201</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203902</td>
                                <td class="text">查询不到该城市的天气</td>
                                <!--<td class="url">202</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203903</td>
                                <td class="text">查询出错，请重试</td>
                                <!--<td class="url">203</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203904</td>
                                <td class="text">错误的GPS坐标</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203905</td>
                                <td class="text">GPS坐标解析出错，请确认提供的坐标正确（暂支持国内）</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203906</td>
                                <td class="text">IP地址错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203907</td>
                                <td class="text">查询不到该IP地址相关的天气信息</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                ...
                <div class="docs_api_show">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="url" width="200">￥499.00&nbsp;&nbsp;</td>
                                    <td class="url">300000&nbsp;&nbsp;</td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td >&nbsp;</td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467876433" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467876433</a></td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>时间</th>
                                                        ...
                                                        <tr>
                                <td>&nbsp;</td>
                                <td><a href="/news/index/id/80" target="_blank">天气预报接口更新：新增支持城市接口等</a></td>
                                <td class="url">2014-08-04 12:31:45</td>
                            </tr>
                                                    </table>
                    </div>
                </div> -->
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/39" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
