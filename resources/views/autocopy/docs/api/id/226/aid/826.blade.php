...
<header class="width100_v4">
        ...
        <div id="docs_api_main">
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a  href="/docs/api/id/226" title="根据输入区号查询实况天气数据">1.根据输入区号查询实况天气数据</a>
                        </li>
                                                 <li >
                            ...
                            <a  href="/docs/api/id/226/aid/825" title="根据区号逐小时查询AQI">6.根据区号逐小时查询AQI</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/226/aid/826" title="根据经纬度逐小时查询AQI">7.根据经纬度逐小时查询AQI</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.learnapi.cn/xiangji_weather/aqi_byCoo.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.learnapi.cn/xiangji_weather/aqi_byCoo.php?key=YOURKEY&amp;lat=31.2343&amp;lon=121.1234&amp;startTime=2016011612&amp;endTime=2016011613</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">根据输入经纬度逐小时查询AQI</font></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">是</td>
                                    <td>经度(小数位数自行确定，一般不少于四位)如:121.4042</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">lat</td>
                                    <td class="url">double</td>
                                    <td class="url">是</td>
                                    <td>纬度(小数位数自行确定，一般不少于四位)如:121.4042</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">startTime</td>
                                    <td class="url">int</td>
                                    <td class="url">是</td>
                                    <td>预报开始时间(yyyyMMddHH)如:2015083117</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">endTime</td>
                                    <td class="url">int</td>
                                    <td class="url">是</td>
                                    <td>预报结束时间(yyyyMMddHH)如:2015090616</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
    ...
    &quot;reason&quot;: &quot;success&quot;,
    &quot;result&quot;: {
        &quot;startTime&quot;: &quot;2016011612&quot;,
        &quot;series&quot;: [//逐小时数据序列，每个小时一个值,第一条对应starttime
            185,
            184
        ],
        &quot;count&quot;: 2,
        &quot;reqTime&quot;: &quot;20160116231904&quot;,
        &quot;endTime&quot;: &quot;2016011613&quot;
    },
    &quot;error_code&quot;: 0
}</pre>
