                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                            ...
                            <a  href="/docs/api/id/226/aid/824" title="实况空气质量数据">5.实况空气质量数据</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/226/aid/825" title="根据区号逐小时查询AQI">6.根据区号逐小时查询AQI</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.learnapi.cn/xiangji_weather/aqi_byAreaid.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.learnapi.cn/xiangji_weather/aqi_byAreaid.php?key=YOURKEY&amp;areaid=101010100&amp;startTime=2016011612&amp;endTime=2016011613</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">根据输入区号逐小时查询AQI</font></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">int</td>
                                    <td class="url">是</td>
                                    <td>预报结束时间(yyyyMMddHH) 如:2015083117</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
