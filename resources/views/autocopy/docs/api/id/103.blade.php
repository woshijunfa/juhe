...
<head>
<meta charset="utf-8">
<meta name="keywords" content="身份证实名认证数据接口,API数据调用" />
...
<title>身份证实名认证数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a103.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">103</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">973</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请身份证实名认证 API" data="/myData/apply/id/103">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/103" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="103"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/103" title="身份证实名查询">1.身份证实名查询</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://op.juhe.cn/idcard/query</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://op.juhe.cn/idcard/query?key=您申请的KEY&amp;idcard=420104198905015713&amp;realname=%E7%8E%8B%E9%9D%9E%E5%90%9F</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">查询不成功，不计费</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/103" target="_blank">API测试工具</a></div>
    ...
    &quot;reason&quot;: &quot;成功1&quot;,
    &quot;result&quot;: {
        &quot;realname&quot;: &quot;董好帅&quot;,<font color='red'>/*真实姓名*/</font>
        &quot;idcard&quot;: &quot;330329199001020012&quot;,<font color='red'>/*身份证号码*/</font>
        &quot;res&quot;: 1 <font color='red'>/*1：匹配 2：不匹配*/</font>
    },
    &quot;error_code&quot;: 0
}</pre>
                            </div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">210301</td>
                                <td class="text">库中无此身份证记录</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">210302</td>
                                <td class="text">第三方服务器异常</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">210303</td>
                                <td class="text">服务器维护</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">210304</td>
                                <td class="text">参数异常</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">210305</td>
                                <td class="text">网络错误，请重试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">210306</td>
                                <td class="text">参数错误，具体参照reason</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                ...
                <div class="docs_api_show">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="url" width="200">￥9999.00&nbsp;&nbsp;</td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878683" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878683</a></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/103" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
