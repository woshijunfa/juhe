...
<head>
<meta charset="utf-8">
<meta name="keywords" content="判断银行卡类型及真伪数据接口,API数据调用" />
...
<title>判断银行卡类型及真伪数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a197.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>判断银行卡类型及真伪</strong>
                                                <span class="h1_span color_auto">爱迈瑞商贸</span>
                        
                                                                        
                                            </h2>
                    <p class="doc_api_decsP">通过银行卡查询，可以判断卡类型。</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">197</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">533</font></p>
                            <p><b>接入服务商：</b><font color="#03c5ff">爱迈瑞商贸</font></p>
                        </div>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请判断银行卡类型及真伪 API" data="/myData/apply/id/197">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/197" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="197"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/197" title="银行卡卡种查询">1.银行卡卡种查询</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://detectionBankCard.api.juhe.cn/bankCard</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://detectionBankCard.api.juhe.cn/bankCard?key=f686f3eee51d0d8c50827dbff361e744&amp;cardid=6226220113414063</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">通过银行卡号返回卡种及相关信</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/197" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <th>说明</th>
                                                                  ...
                                                                  <tr>
                                    <td >&nbsp;</td>
                                    <td class="url" width="200">99元套餐</td>
                                    ...
                                    <td></td>
                                                                    ...
                                                                    <tr>
                                    <td >&nbsp;</td>
                                    <td class="url" width="200">49元套餐</td>
                                    <td class="url" width="200">￥49.00&nbsp;&nbsp;</td>
                                    <td class="url">4500&nbsp;&nbsp;</td>
                                    <td></td>
                                  </tr>
                                                              </table>
                        </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/197" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">基金财务数据</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/103"><img src="/themes/images/data/new/a103.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/103">身份证实名认证</a></p>
                    <p class="apides">检测姓名和身份证号是否一致。</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/199"><img src="/themes/images/data/new/a199.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/199">身份证头像验证</a></p>
                    <p class="apides">根据真实姓名和身份证号，获取身份证头像照片的Base64字符串编码。</p>
                </li>
                            </ul>
