...
<title>邮编查询数据接口_免费API接口调用-分享数据</title>
        ...
        <div id="docs_api_main">
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.shareapi.com/postcode/query</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.shareapi.com/postcode/query?postcode=215001&amp;key=申请的KEY</span></div>
