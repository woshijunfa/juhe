...
<head>
<meta charset="utf-8">
<meta name="keywords" content="邮编查询数据接口,API数据调用" />
...
<title>邮编查询数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a66.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">66</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">1850</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请邮编查询 API" data="/myData/apply/id/66">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/66" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="66"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/66" title="邮编查询地名">1.邮编查询地名</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/66/aid/177" title="省份城市区域列表">2.省份城市区域列表</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/66/aid/178" title="地名查询邮编">3.地名查询邮编</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/postcode/query</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/postcode/query?postcode=215001&amp;key=申请的KEY</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">通过邮编查询对应的地名</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/66" target="_blank">API测试工具</a></div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">206601</td>
                                <td class="text">错误的邮编号码</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">206602</td>
                                <td class="text">错误的省份ID</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">206603</td>
                                <td class="text">错误的城市ID</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">206604</td>
                                <td class="text">错误的地区ID</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878658" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878658</a></td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>时间</th>
                                                        ...
                                                        <tr>
                                <td>&nbsp;</td>
                                <td><a href="/news/index/id/90" target="_blank">邮编查询API上线啦</a></td>
                                <td class="url">2014-09-10 08:58:57</td>
                            </tr>
                                                    </table>
                    </div>
                </div> -->
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/66" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">汇集了所有主流网上商城的报价、促销、抢购、团购信息</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/116"><img src="/themes/images/data/new/a116.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/116">恋爱物语</a></p>
                    <p class="apides">恋爱物语，表白、讨好、唠嗑语句大全</p>
                </li>
                                <li>
                    ...
                    <p class="apides">通过请求10位或13位的ISBN码可以反馈给用户相应的书籍信息和推荐指数</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/121"><img src="/themes/images/data/new/a121.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/121">笑话大全</a></p>
                    <p class="apides">笑话大全</p>
                </li>
                            </ul>
