...
<head>
<meta charset="utf-8">
<meta name="keywords" content="银行卡类别查询数据接口,API数据调用" />
...
<title>银行卡类别查询数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a221.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>银行卡类别查询</strong>
                                                <span class="h1_span color_auto">第三方自助接入</span>
                        
                                                                        
                                            </h2>
                    <p class="doc_api_decsP">根据银行卡号判断真伪、查询类型、logo、客服电话</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">221</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">529</font></p>
                            <p><b>接入服务商：</b><font color="#03c5ff">第三方</font></p>
                        </div>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请银行卡类别查询 API" data="/myData/apply/id/221">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/221" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="221"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/221" title="银行卡类别查询">1.银行卡类别查询</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://bankcardsilk.api.shareapi.com/bankcardsilk/query.php?num=6228480402564890018</span></div>
                                                ...
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/221" target="_blank">API测试工具</a></div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/221" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
