...
<head>
<meta charset="utf-8">
<meta name="keywords" content="三网手机实名制认证数据接口,API数据调用" />
...
<title>三网手机实名制认证数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a208.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">208</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">866</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请三网手机实名制认证 API" data="/myData/apply/id/208">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/208" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="208"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/208" title="手机实名校验">1.手机实名校验</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/telecom/query</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/telecom/query?key=&amp;idcard=332329198801011234X&amp;realname=%E8%91%A3%E5%A5%BD%E5%B8%85&amp;mobile=18912341234</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">根据姓名、身份证、手机号码校验是否一致，支持移动、电信、联通号码</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/208" target="_blank">API测试工具</a></div>
    ...
    &quot;result&quot;: {
        &quot;realname&quot;: &quot;董好帅&quot;,
        &quot;mobile&quot;: &quot;18912341234&quot;,
        &quot;idcard&quot;: &quot;331329198801011234&quot;,
        &quot;res&quot;: 2,<font color='red'>/*匹配结果：1匹配 2不匹配*/</font>
        &quot;resmsg&quot;: &quot;手机号和证件号一致，姓名不一致&quot;
    },
    &quot;error_code&quot;: 0
}</pre>
                            </div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">220801</td>
                                <td class="text">服务商网络异常，请重试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">220802</td>
                                <td class="text">查询失败，具体参照reason</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">220804</td>
                                <td class="text">手机号码格式不正确</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">220805</td>
                                <td class="text">姓名不合法</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">220806</td>
                                <td class="text">身份证号码不合法</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                ...
                <div class="docs_api_show">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="url" width="200">￥1299.00&nbsp;&nbsp;</td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878695" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878695</a></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/208" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">净值数据</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/232"><img src="/themes/images/data/new/a232.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/232">中国股权投资行业数据库</a></p>
                    <p class="apides">中国创业投资和私募股权投资领域综合数据服务提供商</p>
                </li>
                            </ul>
