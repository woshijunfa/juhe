...
<head>
<meta charset="utf-8">
<meta name="keywords" content="中国股权投资行业数据库数据接口,API数据调用" />
...
<title>中国股权投资行业数据库数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a232.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>中国股权投资行业数据库</strong>
                                                <span class="h1_span color_auto">企名片</span>
                        
                                                                        
                                            </h2>
                    <p class="doc_api_decsP">中国创业投资和私募股权投资领域综合数据服务提供商</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">232</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">332</font></p>
                            <p><b>接入服务商：</b><font color="#03c5ff">企名片</font></p>
                        </div>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请中国股权投资行业数据库 API" data="/myData/apply/id/232">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/232" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="232"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/232" title="企业投融资查询">1.企业投融资查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/232/aid/882" title="企业概要信息查询">2.企业概要信息查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/232/aid/883" title="产品信息查询">3.产品信息查询</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://qmpapi.api.shareapi.com/h/qmprongzi</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://qmpapi.api.shareapi.com/h/qmprongzi?time=2016.2.28</span></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>返回说明</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">count</td>
                                    <td class="url">string</td>
                                    <td>返回结果条数</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. product</td>
                                    <td class="url">string</td>
                                    <td>产品名称</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. company</td>
                                    <td class="url">string</td>
                                    <td>公司名称</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. icon</td>
                                    <td class="url">string</td>
                                    <td>公司icon</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. open_time</td>
                                    <td class="url">string</td>
                                    <td>公司成立时间</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. company_faren</td>
                                    <td class="url">string</td>
                                    <td>公司法人</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. company_ziben</td>
                                    <td class="url">string</td>
                                    <td>公司注册资本</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. desc</td>
                                    <td class="url">string</td>
                                    <td>公司描述</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. hangye1</td>
                                    <td class="url">string</td>
                                    <td>行业大类</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. hangye2</td>
                                    <td class="url">string</td>
                                    <td>行业子类</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. yewu</td>
                                    <td class="url">string</td>
                                    <td>主营业务</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. gw_link</td>
                                    <td class="url">string</td>
                                    <td>官网链接</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. from</td>
                                    <td class="url">string</td>
                                    <td>融资新闻来源</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. money</td>
                                    <td class="url">string</td>
                                    <td>融资金额</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. jieduan</td>
                                    <td class="url">string</td>
                                    <td>融资阶段</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. tzr</td>
                                    <td class="url">string</td>
                                    <td>投资人</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. time</td>
                                    <td class="url">string</td>
                                    <td>融资时间</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">items. source</td>
                                    <td class="url">string</td>
                                    <td>披露来源</td>
                                  </tr>
                                                              </table>
    ...
    &quot;result&quot;: {
        ...
        &quot;items&quot;: [
            {
                &quot;product&quot;: &quot;融云&quot;, 
                &quot;company&quot;: &quot;北京云中融信网络科技有限公司&quot;, 
                &quot;icon&quot;: &quot;http://img.798youxi.com/product/icon/356A9216-8CD1-4921-97C5-859725FF24D5.png&quot;, 
                &quot;open_time&quot;: &quot;2015-03-18&quot;, 
                &quot;company_faren&quot;: &quot;韩迎&quot;, 
                &quot;company_ziben&quot;: &quot;600万元人民币&quot;, 
                &quot;desc&quot;: &quot;融云即时通讯云是一个面向开发者的即时通讯云服务提供商，包括客户端IM组件、客户端IM基础库、服务端REST API、客户端实时网络通讯基础库等。&quot;, 
                &quot;hangye1&quot;: &quot;企业服务&quot;, 
                &quot;hangye2&quot;: &quot;企业IT服务&quot;, 
                &quot;yewu&quot;: &quot;即时通讯云服务提供商&quot;, 
                &quot;gw_link&quot;: &quot;http://api.798youxi.com/h/redirect?type=gw&amp;url=http%3A%2F%2Fwww.rongcloud.cn%2F&quot;, 
                &quot;from&quot;: &quot;ctsbw&quot;, 
                &quot;money&quot;: &quot;5000万人民币&quot;, 
                &quot;jieduan&quot;: &quot;A轮&quot;, 
                &quot;tzr&quot;: &quot;中兴合创领投&quot;, 
                &quot;time&quot;: &quot;2016.2.28&quot;, 
                &quot;source&quot;: &quot;http://www.ctsbw.com/article-3535.html&quot;
            }
        ]
    }
}</pre>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <th>说明</th>
                                                                  ...
                                                                  <tr>
                                    <td >&nbsp;</td>
                                    <td class="url" width="200">试用套餐</td>
                                    <td class="url" width="200">￥1.00&nbsp;&nbsp;</td>
                                    <td class="url">10&nbsp;&nbsp;</td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td >&nbsp;</td>
                                    <td class="url" width="200">常规套餐</td>
                                    <td class="url" width="200">￥10.00&nbsp;&nbsp;</td>
                                    <td class="url">100&nbsp;&nbsp;</td>
                                    <td></td>
                                  </tr>
                                                              </table>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/221"><img src="/themes/images/data/new/a221.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/221">银行卡类别查询</a></p>
                    <p class="apides">根据银行卡号判断真伪、查询类型、logo、客服电话</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/26"><img src="/themes/images/data/new/a26.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/26">暂停基金</a></p>
                    <p class="apides">暂停基金</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/188"><img src="/themes/images/data/new/a188.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/188">银行卡二元素检测</a></p>
                    <p class="apides">检测输入的姓名、银行卡号是否一致。</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/208"><img src="/themes/images/data/new/a208.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/208">三网手机实名制认证</a></p>
                    <p class="apides">支持移动、电信、联通号码；检验姓名、身份证、手机号码是否一致。</p>
                </li>
                            </ul>
