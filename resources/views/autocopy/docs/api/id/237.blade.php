...
<head>
<meta charset="utf-8">
<meta name="keywords" content="个人履历查询数据接口,API数据调用" />
...
<title>个人履历查询数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a237.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>个人履历查询</strong>
                                                <span class="h1_span color_juhe">分享数据</span>
                        
                                                                        
                                            </h2>
                    <p class="doc_api_decsP">暂支持在上海工作的人群覆盖，以及部分江苏等其他地区的个人经历</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">237</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">8</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请个人履历查询 API" data="/myData/apply/id/237">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/237" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="237"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/237" title="个人履历查询">1.个人履历查询</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.learnapi.cn/resumeinfo/index.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.learnapi.cn/resumeinfo/index.php?key=KEY&amp;idCard=12345678&amp;name=张三&amp;test=test</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">暂做到在上海工作的人群覆盖，江苏等其他地区的个人经历也会有，但不全。</font></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>姓名</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">test</td>
                                    <td class="url">String</td>
                                    <td class="url">否</td>
                                    <td>如果该参数不为空，则获取测试数据，不扣次数</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
    ...
    &quot;result&quot;: {
        &quot;list&quot;: [
            {
                &quot;cname&quot;: &quot;上海中企人力资源咨询有限公司&quot;,<font color='red'>/*公司名称*/</font>
                &quot;pname&quot;: &quot;张三&quot;,<font color='red'>/*姓名*/</font>
                &quot;periodFrom&quot;: &quot;null&quot;,<font color='red'>/*开始日期*/</font>
                &quot;periodTo&quot;: &quot;20101112&quot;,<font color='red'>/*结束日期*/</font>
                &quot;regisCode&quot;: &quot;310110000235655&quot;,<font color='red'>/*所在单位注册号*/</font>
                &quot;certiCode&quot;: &quot;330327198203280620&quot;,<font color='red'>/*证件号(一般指身份证号)*/</font>
                &quot;certiType&quot;: &quot;身份证&quot;<font color='red'>/*证件类型*/</font>
            },
            {
                &quot;cname&quot;: &quot;上海安迪泰信息技术有限公司&quot;,
                &quot;pname&quot;: &quot;张三&quot;,
                &quot;periodFrom&quot;: &quot;null&quot;,
                &quot;periodTo&quot;: &quot;20160229&quot;,
                &quot;regisCode&quot;: &quot;310104000459472&quot;,
                &quot;certiCode&quot;: &quot;330327198203280620&quot;,
                &quot;certiType&quot;: &quot;身份证&quot;
            }
        ]
    },
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">223701</td>
                                <td class="text">参数错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">223702</td>
                                <td class="text">服务商网络异常，请重试!</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">223703</td>
                                <td class="text">未查询到相关信息</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                ...
                <div class="docs_api_show">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="url" width="200">￥22.00&nbsp;&nbsp;</td>
                                    <td class="url">1&nbsp;&nbsp;</td>
                                    <td></td>
                                  </tr>
                                                              </table>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">暂停基金</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/205"><img src="/themes/images/data/new/a205.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/205">企业工商数据</a></p>
