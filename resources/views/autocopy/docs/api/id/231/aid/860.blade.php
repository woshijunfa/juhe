...
<head>
<meta charset="utf-8">
<meta name="keywords" content="通用礼品卡接口文档数据接口,API数据调用" />
...
<title>通用礼品卡接口文档数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a231.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>通用礼品卡接口文档</strong>
                                                <span class="h1_span color_juhe">聚合数据</span>
                        
                                                <span class="h1_span color_https">支持HTTPS</span>                        
                                            </h2>
                    <p class="doc_api_decsP">集于各商家（KFC、必胜客、GAP等）实体卡和会员卡的API虚拟卡，可用于线上/下消费、移动支付。</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">231</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">607</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请通用礼品卡接口文档 API" data="/myData/apply/id/231">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/231" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="231"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a  href="/docs/api/id/231" title="商品列表">1.商品列表</a>
                        </li>
                                                 <li >
                            <a class="selected" href="/docs/api/id/231/aid/860" title="发货">2.发货</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/231/aid/874" title="订单详情">3.订单详情</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/231/aid/879" title="历史订单查询">4.历史订单查询</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/giftCard/delivery</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/giftCard/delivery</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">发货，会先尝试从您的聚合余额里扣款，请保证余额充足（不可透支）；卡密一经售出，非卡密本身质量原因，概不退换</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/231" target="_blank">API测试工具</a></div>
                        ...
                        <div class="simpleline simpleTable">
                            ...
                            <b>JSON返回示例：</b>
                            <div class="prediv">
                                <pre><font color='red'>/*请注意，发货时可能会返回“此商品暂无库存”，请联系我们客服并告知您需要的卡种类、数量，以便我们备货*/</font>


{
  &quot;reason&quot;: &quot;成功的返回&quot;,
  &quot;result&quot;: {
    &quot;juheOrderId&quot;: &quot;JUHE14575079213274NN&quot;, <font color='red'>/*聚合订单号*/</font>
    &quot;num&quot;: 1, <font color='red'>/*本次发货数量*/</font>
    &quot;cards&quot;: [ <font color='red'>/*卡信息*/</font>
      {
        &quot;cardNo&quot;: &quot;DCDCDCJUHEDCDC&quot;, <font color='red'>/*DES加密后的卡号，解密方法见：http://code.juhe.cn/docs/1943、
http://code.juhe.cn/docs/1945*/</font>
        &quot;cardPws&quot;: &quot;YOYOYOYOCKN&quot;, <font color='red'>/*DES加密后的卡密，解密方法见：http://code.juhe.cn/docs/1943、
http://code.juhe.cn/docs/1945*/</font>
        &quot;expireDate&quot;: &quot;20251231&quot; <font color='red'>/*失效时间*/</font>
      }
    ]
  },
  &quot;error_code&quot;: 0
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">223100</td>
                                <td class="text">系统错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">223101</td>
                                <td class="text">参数输入错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">223102</td>
                                <td class="text">您的余额不足</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">223103</td>
                                <td class="text">库存不足</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="api_table">
    ...
    <tr>
      <td >&nbsp;</td>
      <td class="text" colspan="3">具体礼品卡种类、价格请参照商品列表接口或咨询客服</td>
    </tr>
   <tr>
      <td >&nbsp;</td>
      <td class="text" colspan="3" style="color:red">部分礼品卡有官方发卡规则限制，如有大批量采购需求，请联系客服，客服电话：400-882-7715；卡密一经售出，非卡密本身质量原因，概不退换</td>
    </tr>
</table>
</div>
                                        <div class="simpleline simpleTable">
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467881206" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467881206</a></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/231" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/107"><img src="/themes/images/data/new/a107.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/107">苹果APP游戏充值</a></p>
                    <p class="apides">苹果app游戏在线直充</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/227"><img src="/themes/images/data/new/a227.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/227">个人社保缴纳</a></p>
                    <p class="apides">支持指定城市社保公积金缴费比例查询和补缴计算、正常缴纳以及补缴，测试完毕后请联系商务获取正式生产环境接口。服务费：请咨询客服</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/85"><img src="/themes/images/data/new/a85.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/85">手机话费充值</a></p>
                    <p class="apides">手机话费快速充值</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/115"><img src="/themes/images/data/new/a115.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/115">固话/宽带直充</a></p>
