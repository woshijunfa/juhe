        ...
        <div id="docs_api_main">
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.shareapi.com/giftCard/order</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.shareapi.com/giftCard/order?key=您的APPKEY&amp;juheOrderId=123233123312</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">根据分享订单号查询订单详情</font></div>
