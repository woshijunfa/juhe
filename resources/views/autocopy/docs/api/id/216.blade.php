...
<head>
<meta charset="utf-8">
<meta name="keywords" content="CBA球队赛事信息数据接口,API数据调用" />
...
<title>CBA球队赛事信息数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a216.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>CBA球队赛事信息</strong>
                        
                                            </h2>
                    <p class="doc_api_decsP">CBA球队、球馆、赛事相关信息查询</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">216</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">340</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请CBA球队赛事信息 API" data="/myData/apply/id/216">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/216" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="216"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/216" title="球队基本信息">1.球队基本信息</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/216/aid/747" title="根据球队ID获取球员信息">2.根据球队ID获取球员信息</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/216/aid/748" title="根据球队ID获取赛程信息">3.根据球队ID获取赛程信息</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/216/aid/749" title="根据比赛ID获取技术统计">4.根据比赛ID获取技术统计</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/216/aid/750" title="根据比赛ID获取总技术统计">5.根据比赛ID获取总技术统计</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/cba/teamList.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/cba/teamList.php?key=YOURKEY</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">获取球队的基本信息</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/216" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>返回内容</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">team_id</td>
                                    <td class="url">int</td>
                                    <td>球队ID</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">team_name</td>
                                    <td class="url">string</td>
                                    <td>球队名</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">all_name</td>
                                    <td class="url">string</td>
                                    <td>球队全名</td>
                                  </tr>
                                                                    <tr>
                                    ...
                                    <td>球队主场所在城市</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">gymnasium</td>
                                    <td class="url">string</td>
                                    <td>球馆</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">coach</td>
                                    <td class="url">string</td>
                                    <td>教练</td>
                                  </tr>
                                                                    <tr>
    ...
    &quot;result&quot;: [
        {
            ...
            &quot;gymnasium&quot;: &quot;雅戈尔体育馆&quot;,
            &quot;coach&quot;: &quot;阿的江&quot;,
            &quot;logo&quot;: &quot;http://www.cba.gov.cn/cbastats/adm/cbadata/pic/20061230201780.jpg&quot;,
            &quot;info&quot;: &quot;八一火箭队是CBA联赛历史上的一支传奇球队，隶属于中国人民解放军八一体工大队。利用其独有的球队体制，在1996年至2001年赛季间，他们垄断了所有的六届联赛冠军，球队人才济济，涌现出了阿的江、刘玉栋、李楠、范斌、张劲松、王治郅等众多国内篮坛传奇球员，球队鼎盛时期号称“半支国家队”，球队的主力球员均为中国国家男子篮球队成员。 八一队创造了诸多辉煌的纪录，其中包括11次打进CBA总决赛、8次夺得冠军、3次获得亚军。八一队曾经创造了48连胜的惊人纪录，这也是CBA历史上最长的连胜纪录。&quot;
        },
        {
            &quot;team_id&quot;: 18,
            &quot;team_name&quot;: &quot;青岛雄鹰&quot;,
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">221600</td>
                                <td class="text">网络错误，请稍后重试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">221601</td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/216" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">NBA赛事赛程相关信息</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/223"><img src="/themes/images/data/new/a223.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/223">NBA赛事球员信息大全</a></p>
                    <p class="apides">NBA赛事、球队、球员、统计等相关信息查询</p>
                </li>
                            </ul>
