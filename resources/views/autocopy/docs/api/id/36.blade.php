...
<head>
<meta charset="utf-8">
<meta name="keywords" content="全国车辆违章数据接口,API数据调用" />
...
<title>全国车辆违章数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a36.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>全国车辆违章</strong>
                                                <span class="h1_span color_juhe">聚合数据</span>
                        
                                                <span class="h1_span color_https">支持HTTPS</span>                        
                                            </h2>
                    <p class="doc_api_decsP">目前已经支持300个左右的城市违章查询</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">36</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">17130</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请全国车辆违章 API" data="/myData/apply/id/36">申请数据</a>
                        
                        
                                                <a class="api_newbtn_demo" href="/docs/demo/id/36" target="_blank">查看演示</a>
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/36" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="36"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/36" title="获取支持城市参数接口">1.获取支持城市参数接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/36/aid/101" title="请求违章查询接口">2.请求违章查询接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/36/aid/116" title="接口剩余请求次数查询">3.接口剩余请求次数查询</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/wz/citys</span></div>
                        <div class="simpleline"><strong>支持格式：</strong><span class="url">json/xml/jsonp</span></div>
                        <div class="simpleline"><strong>请求方式：</strong><span class="url">get post</span></div>
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/wz/citys?key=key</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color=""><font color=red>有些城市如果维护，我们会临时下线处理</font></font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/36" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">string</td>
                                    <td class="url">N</td>
                                    <td>返回数据格式：json或xml或jsonp,默认json</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    ...
                                    <td>格式选择1或2，默认1</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">callback</td>
                                    <td class="url">String</td>
                                    <td class="url">N</td>
                                    <td>返回格式选择jsonp时，必须传递</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">key</td>
                        ...
                        <div class="simpleline simpleTable">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">Array</td>
                                    <td>省份下开通城市数组</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">city_code</td>
                                    <td class="url">String</td>
                                    <td>城市代码</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">city_name</td>
                                    <td class="url">String</td>
                                    <td>城市名称</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">engine</td>
                                    <td class="url">Int</td>
                                    <td>是否需要发动机号0,不需要 1,需要</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">engineno</td>
                                    <td class="url">Int</td>
                                    <td>需要几位发动机号0,全部 1-9 ,需要发动机号后N位</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">class</td>
                                    <td class="url">Int</td>
                                    <td>是否需要车架号0,不需要 1,需要</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">classa</td>
                                    <td class="url">Int</td>
                                    <td>同上,（解决java中class关键字无法映射）</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">classno</td>
                                    <td class="url">Int</td>
                                    <td>需要几位车架号0,全部 1-9 需要车架号后N位</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url"></td>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">203602</td>
                                <td class="text">车辆信息不存在</td>
                                <!--<td class="url">202</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203603</td>
                                <td class="text">网络错误请重试</td>
                                <!--<td class="url">203</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203604</td>
                                <td class="text">传递参数的格式不正确</td>
                                <!--<td class="url">204</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203605</td>
                                <td class="text">没找到此城市代码或该城市正在维护</td>
                                <!--<td class="url">205</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203606</td>
                                <td class="text">车辆信息错误,请确认输入的信息正确</td>
                                <!--<td class="url">206</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203607</td>
                                <td class="text">交管局网络原因暂时无法查询</td>
                                <!--<td class="url">207</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">203608</td>
                                <td class="text">您好,你所查询的城市正在维护或未开通查询</td>
                                <!--<td class="url">208</td>-->
                              </tr>
                                                      </table>
                    </div>
                ...
                <div class="docs_api_show">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="url" width="200">￥999.00&nbsp;&nbsp;</td>
                                    <td class="url">26000&nbsp;&nbsp;</td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td >&nbsp;</td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467876473" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467876473</a></td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>时间</th>
                                                        ...
                                                        <tr>
                                <td>&nbsp;</td>
                                <td><a href="/news/index/id/148" target="_blank">全国车辆违章查询接口资费调整公告</a></td>
                                <td class="url">2015-02-12 11:26:31</td>
                            </tr>
                                                        <tr>
                                <td>&nbsp;</td>
                                <td><a href="/news/index/id/147" target="_blank">聚合数据车辆违章震撼升级！</a></td>
                                <td class="url">2015-02-09 14:54:39</td>
                            </tr>
                                                        <tr>
                                <td>&nbsp;</td>
                                <td><a href="/news/index/id/142" target="_blank">聚合数据车辆违章数据即将升级啦！</a></td>
                                <td class="url">2015-02-04 19:18:52</td>
                            </tr>
                                                    </table>
                    </div>
                </div> -->
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/36" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
