...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a80.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请汇率 API" data="/myData/apply/id/80">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/80" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="80"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a  href="/docs/api/id/80" title="常用汇率查询">1.常用汇率查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/80/aid/204" title="货币列表">2.货币列表</a>
                        </li>
                                                 <li >
                            <a class="selected" href="/docs/api/id/80/aid/205" title="实时汇率查询换算">3.实时汇率查询换算</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://op.learnapi.cn/onebox/exchange/currency</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://op.learnapi.cn/onebox/exchange/currency?key=您申请的APPKEY&amp;from=JPY&amp;to=BHD</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">实时货币汇率查询换算</font></div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">208001</td>
                                <td class="text">货币兑换名称不能为空</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">208002</td>
                                <td class="text">查询不到汇率相关信息</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">208003</td>
                                <td class="text">网络错误，请重试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">208004</td>
                                <td class="text">查询不到常用货币相关信息</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">208005</td>
                                <td class="text">不存在的货币种类</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">208006</td>
                                <td class="text">查询不到该货币兑换相关信息</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
