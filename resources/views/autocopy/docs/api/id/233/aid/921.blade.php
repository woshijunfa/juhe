...
<title>账户及业务安全检测数据接口_免费API接口调用-分享数据</title>
        ...
        <div id="docs_api_main">
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.shareapi.com/risk/common</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.shareapi.com/risk/common</span></div>
    ...
    &quot;error_code&quot;: 0
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">数据由上海信息委提供的，分享免费开放</p>
                </li>
                                <li>
