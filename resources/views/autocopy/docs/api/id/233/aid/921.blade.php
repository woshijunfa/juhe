...
<head>
<meta charset="utf-8">
<meta name="keywords" content="账户及业务安全检测数据接口,API数据调用" />
...
<title>账户及业务安全检测数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a233.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">233</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">123</font></p>
                            <p><b>接入服务商：</b><font color="#03c5ff">乌云漏洞平台</font></p>
                        </div>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请账户及业务安全检测 API" data="/myData/apply/id/233">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/233" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="233"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a  href="/docs/api/id/233" title="验证用户账户安全">1.验证用户账户安全</a>
                        </li>
                                                 <li >
                            <a class="selected" href="/docs/api/id/233/aid/921" title="验证业务数据安全">2.验证业务数据安全</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/risk/common</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/risk/common</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">根据不同数据类型，判断当前信息是否为恶意IP、薅羊毛手机号、盗刷银行卡号。ip、mobile、credit 三个参数中只需传一个，并且要与 type 类型对应。</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/233" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>需验证的 ip 地址（判断是否为恶意IP）。ip、mobile、credit 三个参数中只需传一个，并且要与 type 类型对应。</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    ...
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>需验证的手机号（判断是否为薅羊毛手机号）</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">credit</td>
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>需验证的银行卡号（判断是否为盗刷银行卡号）</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
    ...
    &quot;reason&quot;: &quot;查询成功&quot;,
    &quot;result&quot;: {
        &quot;issafe&quot;: &quot;1&quot;,<font color='red'>/*1:安全 2:不安全*/</font>
        &quot;msg&quot;: &quot;数据安全&quot;
    },
    &quot;error_code&quot;: 0
}</pre>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878773" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878773</a></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/233" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/101"><img src="/themes/images/data/new/a101.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/101">上海市政数据</a></p>
                    <p class="apides">数据由上海信息委提供的，聚合免费开放</p>
                </li>
                                <li>
                    ...
                    <p class="apides">全国免费的WIFI热点分布</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/110"><img src="/themes/images/data/new/a110.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/110">北京市政务数据</a></p>
                    <p class="apides">北京本地数据，包含餐饮美食，交通服务，旅游住宿等多类数据。</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/204"><img src="/themes/images/data/new/a204.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/204">标准中文电码查询</a></p>
