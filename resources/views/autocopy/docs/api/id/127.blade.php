...
<head>
<meta charset="utf-8">
<meta name="keywords" content="景点门票数据接口,API数据调用" />
...
<title>景点门票数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a127.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请景点门票 API" data="/myData/apply/id/127">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/127" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="127"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/127" title="景区详情查询接口">1.景区详情查询接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/904" title="分销商票型查询接口">2.分销商票型查询接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/905" title="分销产品变更增量拉取接口">3.分销产品变更增量拉取接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/906" title="分销产品下线拉取接口">4.分销产品下线拉取接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/907" title="退改规则信息查询">5.退改规则信息查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/908" title="退改规则变化的产品id拉取接口">6.退改规则变化的产品id拉取接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/909" title="价格日历查询接口">7.价格日历查询接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/910" title="场次查询接口">8.场次查询接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/911" title="下单验证接口">9.下单验证接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/912" title="下单接口">10.下单接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/913" title="短信重发接口">11.短信重发接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/914" title="订单查询接口">12.订单查询接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/915" title="根据第三方流水号查询订单">13.根据第三方流水号查询订单</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/916" title="取消订单接口">14.取消订单接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/917" title="退款结果回调接口">15.退款结果回调接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/918" title="订单问题反馈接口">16.订单问题反馈接口</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/127/aid/919" title="订单问题反馈结果查询接口">17.订单问题反馈结果查询接口</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://api2.juheapi.com/tongc/sceneryDetail</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://api2.juheapi.com/tongc/sceneryDetail</span></div>
                                                ...
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/127" target="_blank">API测试工具</a></div>
                        ...
                        <div class="simpleline simpleTable">
                            ...
                            <div class="prediv">
                                <pre>{
&quot;SceneryID&quot;:10224,<font color='red'>/*景区ID*/</font>
&quot;SceneryName&quot;:&quot;金鸡湖&quot;,<font color='red'>/*景区名称*/</font>
&quot;SceneryGrade&quot;:4,<font color='red'>/*景区等级*/</font>
&quot;SceneryAddress&quot;:&quot;sr&quot;,<font color='red'>/*景区地址*/</font>
&quot;SceneryProvinceName&quot;:&quot;江苏&quot;,<font color='red'>/*景区所在省份名称*/</font>
&quot;SceneryCityName&quot;:&quot;苏州&quot;,<font color='red'>/*景区所在城市名称*/</font>
&quot;ScenerySummary&quot;:&quot;&lt;p&gt;金鸡湖，因传说有金鸡落于湖中而得&quot;,<font color='red'>/*景区简介*/</font>
&quot;UserNotes&quot;:{<font color='red'>/*预定须知*/</font>
&quot;BusinessHours&quot;:&quot;&quot;,<font color='red'>/*开放时间*/</font>
&quot;GetTicketAddress&quot;:&quot;&quot;,<font color='red'>/*取票地点*/</font>
&quot;RuYuanVoucher&quot;:&quot;&quot;,<font color='red'>/*入园凭证*/</font>
&quot;FavouredPolicy&quot;:&quot;&quot;,<font color='red'>/*特惠政策*/</font>
&quot;Reminder&quot;:&quot;&quot;<font color='red'>/*温馨提示*/</font>
},
&quot;SceneryLongitude&quot;:120.7,<font color='red'>/*经度（坐标*/</font>
&quot;SceneryLatitude&quot;:31.32,<font color='red'>/*纬度（坐标）*/</font>
&quot;SceneryAliasName&quot;:&quot;&quot;,<font color='red'>/*景区别名*/</font>
&quot;SceneryTrafficGuide&quot;:&quot;位于苏州城东，苏州工业园区内公交307路、28路、26路、68路、47路可以到达。&quot;,<font color='red'>/*交通方式*/</font>
&quot;PictureListInfo&quot;:[<font color='red'>/*图片信息*/</font>
{
            &quot;SceneryImgRemarks&quot;: &quot;&quot;,<font color='red'>/*图片信息*/</font>
            &quot;SceneryImgPath&quot;: <font color='red'>/*图片地址*/</font>&quot;http://pic2.40017.cn/scenery/2014/08/13/2/201408131410572645731_450x280_00.jpg&quot;
        },
   ...
]
}</pre>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">212701</td>
                                <td class="text">票数和人数不一致</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">212702</td>
                                <td class="text">订单号不存在，请检查appkey和orderid，或者订单并未创建成功</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">212703</td>
                                <td class="text">该订单已经退票成功，请不要重复操作</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">212704</td>
                                <td class="text">金额填写有误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">212705</td>
                                <td class="text">订单号已存在</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">212706</td>
                                <td class="text">账户余额不足，请充值</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">212707</td>
                                <td class="text">分页参数有误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">212708</td>
                                <td class="text">产品无效</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878618" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878618</a></td>
                            </tr>
                        </table>
                    </div>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/220"><img src="/themes/images/data/new/a220.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/220">旅游景点介绍</a></p>
                    <p class="apides"></p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/127"><img src="/themes/images/data/new/a127.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/127">景点门票</a></p>
                    <p class="apides">提供景点门票信息查询，以及支付下单</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/114"><img src="/themes/images/data/new/a114.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/114">全国公交查询</a></p>
                    <p class="apides">支持全国400多个主要城市</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/99"><img src="/themes/images/data/new/a99.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/99">航班实时起降时间</a></p>
                    <p class="apides">航班实时、历史起降时间查询</p>
                </li>
                            </ul>
