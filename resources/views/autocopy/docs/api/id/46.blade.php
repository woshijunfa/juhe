...
<head>
<meta charset="utf-8">
<meta name="keywords" content="菜谱大全数据接口,API数据调用" />
...
<title>菜谱大全数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a46.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">46</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">17729</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请菜谱大全 API" data="/myData/apply/id/46">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/46" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="46"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/46" title="菜谱大全">1.菜谱大全</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/46/aid/129" title="分类标签列表">2.分类标签列表</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/46/aid/130" title="按标签检索菜谱">3.按标签检索菜谱</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/46/aid/131" title="按菜谱ID查看详细">4.按菜谱ID查看详细</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://apis.juhe.cn/cook/query?key=&amp;menu=%E8%A5%BF%E7%BA%A2%E6%9F%BF&amp;rn=10&amp;pn=3</span></div>
                                                ...
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/46" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>数据返回条数，最大30</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">albums</td>
                                    <td class="url">int</td>
                                    <td class="url">否</td>
                                    <td>albums字段类型，1字符串，默认数组</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url"></td>
...
&lt;/root&gt;</pre>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">204601</td>
                                <td class="text">菜谱名称不能为空</td>
                                <!--<td class="url">201</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">204602</td>
                                <td class="text">查询不到相关信息</td>
                                <!--<td class="url">202</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">204603</td>
                                <td class="text">菜谱名过长</td>
                                <!--<td class="url">203</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">204604</td>
                                <td class="text">错误的标签ID</td>
                                <!--<td class="url">204</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">204605</td>
                                <td class="text">查询不到数据</td>
                                <!--<td class="url">205</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">204606</td>
                                <td class="text">错误的菜谱ID</td>
                                <!--<td class="url">206</td>-->
                              </tr>
                                                      </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467876454" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467876454</a></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/46" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/189"><img src="/themes/images/data/new/a189.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/189">二维码在线生成</a></p>
                    <p class="apides">二维码在线生成</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/229"><img src="/themes/images/data/new/a229.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/229">快递在线下单</a></p>
                    <p class="apides">应用场景：普通用户在线向快递公司在线下单，快递公司收到申请快递员上门取件</p>
                </li>
                                <li>
                    ...
                    <p class="apides">笑话大全</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/95"><img src="/themes/images/data/new/a95.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/95">笑话大全</a></p>
