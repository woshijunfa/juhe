...
<head>
<meta charset="utf-8">
<meta name="keywords" content="健康资讯数据接口,API数据调用" />
...
<title>健康资讯数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a145.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">145</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">2469</font></p>
                            <p><b>接入服务商：</b><font color="#03c5ff">天狗云</font></p>
                        </div>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请健康资讯 API" data="/myData/apply/id/145">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/145" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="145"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/145" title="资讯分类列表">1.资讯分类列表</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/145/aid/460" title="取得资讯信息列表">2.取得资讯信息列表</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/145/aid/459" title="取得详细资讯信息">3.取得详细资讯信息</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://op.juhe.cn/yi18/news/newsclass</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://op.juhe.cn/yi18/news/newsclass?key=您申请到的appkey</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">资讯分类列表</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/145" target="_blank">API测试工具</a></div>
    ...
    &quot;error_code&quot;: 0
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">214500</td>
                                <td class="text">网络错误，请重试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">214501</td>
                                <td class="text">请提供相应的参数</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">214502</td>
                                <td class="text">获取信息失败，请重试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">214503</td>
                                <td class="text">limit参数应小于50</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467877798" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467877798</a></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/145" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/143"><img src="/themes/images/data/new/a143.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/143">健康知识</a></p>
                    <p class="apides">打造专业的知识文化提供平台，提供免费开放的数据接口。我们将会用最全新的方式， 提供专业的文化知识。</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/145"><img src="/themes/images/data/new/a145.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/145">健康资讯</a></p>
