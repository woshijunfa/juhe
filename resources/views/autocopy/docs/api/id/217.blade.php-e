...
<head>
<meta charset="utf-8">
<meta name="keywords" content="周边体育馆查询数据接口,API数据调用" />
...
<title>周边体育馆查询数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a217.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>周边体育馆查询</strong>
                        
                                                                        
                                            </h2>
                    <p class="doc_api_decsP">根据经纬度及体育馆类型查询场馆信息</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">217</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">217</font></p>
                            <p><b>接入服务商：</b><font color="#03c5ff">动云</font></p>
                        </div>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请周边体育馆查询 API" data="/myData/apply/id/217">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/217" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="217"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/217" title="周边体育馆查询">1.周边体育馆查询</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/venues/query.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/venues/query.php?lat=39.92798&amp;lon=116.45&amp;distance=10000&amp;venues_type=&amp;key=YOURKEY</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">根据经纬度及关键字查询体育场馆的信息</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/217" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>你申请的key</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">venues_type</td>
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>场馆类型，默认篮球 目前有篮球、足球、网球、羽毛球、乒乓球、游泳、健身</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">lat</td>
                                    ...
                                    <td>经度</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">distance</td>
                                    <td class="url">int</td>
                                    <td class="url">是</td>
                                    <td>搜索范围（单位：米）最大支持10000m</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>场馆电话</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">image</td>
                                    <td class="url">String</td>
                                    <td>场馆图片</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">shop_hours</td>
                                    <td class="url">String</td>
                                    <td>营业时间</td>
                                  </tr>
                                                              </table>
    ...
    &quot;result&quot;: [
        {
            ...
            &quot;city&quot;: &quot;北京市&quot;,
            &quot;name&quot;: &quot;宏远篮球（东大桥店）&quot;,
            &quot;address&quot;: &quot;北京朝阳区东大桥陈经纶体育馆(蓝岛大厦南侧)&quot;,
            &quot;phone&quot;: &quot;&quot;,
            &quot;image&quot;: &quot;http://i1.s1.dpfile.com/pc/90d725b0e9be981d137eb904afb8dc3b(700x700)/thumb.jpg&quot;,
            &quot;shop_hours&quot;: &quot;&quot;
        },
        {
            &quot;venues_type&quot;: &quot;篮球&quot;,
            ...
            &quot;city&quot;: &quot;北京市&quot;,
            &quot;name&quot;: &quot;工体篮球公园&quot;,
            &quot;address&quot;: &quot;北京市工人体育场东路甲2-1号&quot;,
            &quot;phone&quot;: &quot;010-65523096&quot;,
            &quot;image&quot;: &quot;http://hiphotos.baidu.com/lbsugc/pic/item/50da81cb39dbb6fde434cfa40f24ab18962b37c0.jpg&quot;,
            &quot;shop_hours&quot;: &quot;&quot;
        },
        {
            &quot;venues_type&quot;: &quot;篮球&quot;,
        ...
        },
        {
            ...
            &quot;city&quot;: &quot;北京市&quot;,
            &quot;name&quot;: &quot;梦想之巅篮球俱乐部(朝阳门店)&quot;,
            &quot;address&quot;: &quot;朝阳区朝阳门外大街8号蓝岛大厦内(近东大桥)&quot;,
            &quot;phone&quot;: &quot;(010)62164313&quot;,
            &quot;image&quot;: &quot;http://i3.s1.dpfile.com/pc/d774faf02b93d7f617094eee1b61e339(700c700)/thumb.jpg&quot;,
            &quot;shop_hours&quot;: &quot;周六周日16:00-18:00&quot;
        },
        {
            &quot;venues_type&quot;: &quot;篮球&quot;,
            &quot;province&quot;: &quot;北京市&quot;,
            &quot;city&quot;: &quot;北京市&quot;,
            &quot;name&quot;: &quot;贡院六号篮球场&quot;,
            &quot;address&quot;: &quot;东城区东城建国门内大街贡院6号&quot;,
            &quot;phone&quot;: &quot;(010)65176666,(010)81956205&quot;,
            &quot;image&quot;: &quot;http://i2.s1.dpfile.com/pc/dfb4e4836ea300deda5b7cfff3d56da1(700c700)/thumb.jpg&quot;,
            &quot;shop_hours&quot;: &quot;&quot;
        }
    ],
    &quot;error_code&quot;: 0
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">221700</td>
                                <td class="text">网络错误,请稍后重试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">221701</td>
                                <td class="text">参数错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">221702</td>
                                <td class="text">对应参数无数据</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/217" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
