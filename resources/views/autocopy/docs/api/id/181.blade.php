        ...
        <div id="docs_api_main">
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/181" title="违章城市列表">1.违章城市列表</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/citylist.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/citylist.php?key=你申请的key</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">查询所有支持违章在线查询的城市列表，以及这些城市查询违章的规则，建议每天晚上调用一次，把数据在本地缓存起来</font></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>城市名称</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">prefix</td>
                                    <td class="url">String</td>
                                    <td>车牌前缀名，如”浙A”</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">motorNumLen</td>
                                    <td class="url">int</td>
                                    <td>查询该城市车辆违章时，是否需要要用户提供车辆的发动机号：-1=需要提供完整发动机号;0=不需要提供;N=需要提供发动机号的后N位(N:是motorNumLen字段的值，下面N表示的意义也是一样)</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">frameNumLen</td>
                                    <td class="url">int</td>
                                    <td>是否需要要用户提供车辆的车架号:-1=需要提供完整车架号;0=不需要提供;N=需要提供车架号的后N位</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">owner</td>
                                    <td class="url">boolean</td>
                                    <td>是否需要用户提供车主姓名:true=需要提供车主姓名;false=不需要提供</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">accountLen</td>
                                    <td class="url">int</td>
                                    <td>是否需要要用户提供在该城市交管局官网的账号：(极少数城市查询违章，当地交管局官网需要用户提供自己的账号密码)0=不需要提供;>0=需要提供</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">passwordLen</td>
                                    <td class="url">int	</td>
                                    <td>是否需要要用户提供在该城市交管局官网的密码：(极少数城市查询违章，当地交管局官网需要用户提供自己的账号密码)0=不需要提供;>0=需要提供</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">vehicleRegistNumLen</td>
                                    <td class="url">int</td>
                                    <td>是否需要要用户提供车辆的机动车注册编号：-1=需要提供完整机动车注册编号;0=不需要提供;N=需要提供机动车注册编号的后N位</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url"></td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878709" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878709</a></td>
                            </tr>
                        </table>
                    </div>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">今日汽油价格查询,最新柴油油价实时行情</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/179"><img src="/themes/images/data/new/a179.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/179">免费出行保险</a></p>
                    <p class="apides">该保险由中国平安提供</p>
                </li>
                                <li>
