...
<header class="width100_v4">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                            ...
                            <a  href="/docs/api/id/181/aid/875" title="罚单收费单位配置">11.罚单收费单位配置</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/181/aid/878" title="获取罚单信息">12.获取罚单信息</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/fadan/penalty_info.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/fadan/penalty_info.php?key=你申请的key&amp;payOnline=0&amp;province=广东省&amp;city=江门市&amp;unit=凭决定书号缴费（不要发票）&amp;number=xxxxx&amp;fine=50&amp;penaltyDate=2016-01-01&amp;extraParam={&quot;param1&quot;: &quot;xxxx&quot;, &quot;param2&quot;: &quot;xxxx&quot;,....}</span></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>缴费城市</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">unit</td>
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>缴费单位(根据收费单位配置确定,如果缴费单位配置里面的对应城市没有此字段,则不需要传值)</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">number</td>
                                    <td class="url">int</td>
                                    <td class="url">是</td>
                                    <td>罚单编号</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">fine</td>
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>处罚金额(根据收费单位配置确定)</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">penaltyDate</td>
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>处罚日期(根据收费单位配置确定),格式为:yyyy-MM-dd,如:2016-01-01</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">extraParam</td>
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>扩展参数(根据收费单位配置确定(注意:当field字段为photo时,传参名称为"url";如果有"name":"通知书"这个字段,表示的意思是罚单编号,如果payOnline这个字段值为1,表示的是电子单号,此时传参只需要再传number这个字段的值,其余可不传,这里的扩展参数是除去上面罗列的参数之外的参数)，参数为JSON格式：{"param1": "xxxx", "param2": "xxxx",....}</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url"></td>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>服务费</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">totalAmount</td>
                                    <td class="url">boolean</td>
                                    <td>总金额</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">canPay</td>
                                    <td class="url">boolean</td>
                                    <td>是否可以在线代缴此罚款</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">penalty</td>
                                    <td class="url">JSON</td>
                                    <td>罚单信息</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">	JSON< penalty ></td>
                                    <td class="url"></td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    ...
                                    <td>扩展参数</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">juhe_servicefee</td>
                                    <td class="url">double</td>
                                    <td>聚合服务收费</td>
                                  </tr>
                                                                    <tr>
    ...
    &quot;error_code&quot;: 0
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878739" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878739</a></td>
                            </tr>
                        </table>
                    </div>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/91"><img src="/themes/images/data/new/a91.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/91">违章高发地</a></p>
                    <p class="apides">根据百度地图坐标，检索周边违章高发地信息</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/133"><img src="/themes/images/data/new/a133.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/133">实时停车场数据</a></p>
                    <p class="apides">全国实时停车场信息</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/7"><img src="/themes/images/data/new/a7.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/7">全国加油站油价</a></p>
                    <p class="apides">全国加油站、周边加油站，以及实时油价查询</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/194"><img src="/themes/images/data/new/a194.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/194">VIN车架号车辆识别码查询</a></p>
                    <p class="apides">通过VIN得到车辆品牌、型号、年款、排量、变速箱类型、发动机型号、几门几座等</p>
                </li>
                            </ul>
