                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                            ...
                            <a  href="/docs/api/id/181/aid/880" title="提交罚单订单">13.提交罚单订单</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/181/aid/881" title="配置回调地址">14.配置回调地址</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/callback_config.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/callback_config.php?key=你申请的key&amp;callbackurl=http://www.baidu.com</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">提交回调地址,回调请求方式为post,数据格式为orderId=orderId&order_status=order_status,用户反馈回来的数据格式为{"code":xxx},0:表示回调成功,其他不成功,回调失败后重复两次,否则用户需要自己调用查看订单状态的接口.order_status表示订单状态,orderId表示的是订单id</font></div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878744" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878744</a></td>
                            </tr>
                        </table>
                    </div>
