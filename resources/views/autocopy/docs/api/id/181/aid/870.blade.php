                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                            ...
                            <a  href="/docs/api/id/181/aid/869" title="订单支付">7.订单支付</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/181/aid/870" title="订单状态查询">8.订单状态查询</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/orderStatus.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/orderStatus.php?orderIds=699710&amp;key=你申请的key</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">查询订单的状态,在付款成功后,如果需要提交证件信息,显示状态为3,没有显示为4,则属于延时情况,此时可以提交证件信息,9点半之前提交的  当天审核完成  9点半之后提交的  最迟第二天早上9点半,处理时间是2-7个工作日</font></div>
                        ...
                        <div class="simpleline simpleTable">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>&nbsp;</td>
                                    <td class="url">6</td>
                                    <td class="url">审核失败</td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">7</td>
                                    <td class="url">审核通过</td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    ...
                                    <td>&nbsp;</td>
                                    <td class="url">11</td>
                                    <td class="url">处理失败</td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">12</td>
                                    <td class="url">处理成功</td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878731" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878731</a></td>
                            </tr>
                        </table>
                    </div>
