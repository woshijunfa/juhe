                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                            ...
                            <a  href="/docs/api/id/181/aid/867" title="查询订单详情">5.查询订单详情</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/181/aid/868" title="证件和罚单图片上传">6.证件和罚单图片上传</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/upload.php</span></div>
                        <div class="simpleline"><strong>支持格式：</strong><span class="url">json</span></div>
                        <div class="simpleline"><strong>请求方式：</strong><span class="url">post</span></div>
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/upload.php?key=你申请的key</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">根据订单详情上传证件,要求图片为jpg或者png格式,大小3M以下,此接口不支持用本网页测试工具测试,可以使用htmlform表单模拟提交</font></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>罚单:fadan;违章:weizhang;默认:weizhang</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
...
注意:
  订单状态流转到已审核之前，都可以补全／修改证件资料
  订单一旦审核通过，不能或不需要再上传证件资料
  部分地区可能配置更新不及时，是否需要上传资料，以订单状态是否未已审核为准:
  如果未上传标记的证件，但是订单已审核通过，说明不再需要该资料了;
  如果标记了原本不需要上传的资料，请按要求上传;</pre>
                            </div>
                        </div>
                                                                    </div>
                </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878727" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878727</a></td>
                            </tr>
                        </table>
                    </div>
