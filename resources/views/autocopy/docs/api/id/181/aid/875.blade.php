                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                            ...
                            <a  href="/docs/api/id/181/aid/873" title="订单列表查询">10.订单列表查询</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/181/aid/875" title="罚单收费单位配置">11.罚单收费单位配置</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/fadan/paycost_config.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/fadan/paycost_config.php?key=你申请的key</span></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>省份名称</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">citys</td>
                                    <td class="url">JSON-Array</td>
                                    <td>城市集合</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">valid</td>
                                    <td class="url">boolean</td>
                                    <td>是否支持罚款代缴（true:支持，false:不支持）</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">	citys</td>
                                    ...
                                    <td class="url">boolean</td>
                                    <td>罚单信息获取方式(原样传给接口)</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">units</td>
                                    <td class="url">JSON-Array</td>
                                    <td>缴费单位集合</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">needs</td>
                                    <td class="url">JSON-Array</td>
                                    <td>需要的字段参数集合</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">field</td>
                                    <td class="url">String</td>
                                    <td>参数字段名</td>
                                  </tr>
                                                                    <tr>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878737" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878737</a></td>
                            </tr>
                        </table>
                    </div>
