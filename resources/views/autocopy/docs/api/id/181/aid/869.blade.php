                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                            ...
                            <a  href="/docs/api/id/181/aid/868" title="证件和罚单图片上传">6.证件和罚单图片上传</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/181/aid/869" title="订单支付">7.订单支付</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/payOrder.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/payOrder.php?orderId=699711&amp;key=你申请的key</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">支付订单</font></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>支付的是罚单还是违章(违章订单可不传),默认:违章,罚单:fadan</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878729" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878729</a></td>
                            </tr>
                        </table>
                    </div>
