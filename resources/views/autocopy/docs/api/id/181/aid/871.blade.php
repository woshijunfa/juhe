                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                            ...
                            <a  href="/docs/api/id/181/aid/870" title="订单状态查询">8.订单状态查询</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/181/aid/871" title="提交证件信息">9.提交证件信息</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/submit_certInfo.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/submit_certInfo.php?orderId=699711&amp;certType=1&amp;ownerName=林小雨&amp;imgUrl=16030716223486&amp;key=你申请的key</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">提交证件信息(此接口仅违章代缴需要调用)</font></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">否</td>
                                    <td>证件图片上传返回的地址(以下参数都需要根据订单详情里面的requiredCartInfo字段确定)</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">certType</td>
                                    <td class="url">int</td>
                                    <td class="url">否</td>
                                    <td>证件类型.1:行驶证;2:驾驶证;3:身份证正面;4:身份证背面</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">ownerName</td>
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>车主姓名</td>
                                  </tr>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878733" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878733</a></td>
                            </tr>
                        </table>
                    </div>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">查询车辆故障码，包括故障位置、故障描述、造成影响、和解决建议</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/74"><img src="/themes/images/data/new/a74.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/74">车系查询</a></p>
                    <p class="apides">车系型号、报价、颜色等基本信息查询</p>
                </li>
                            </ul>
