                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                            ...
                            <a  href="/docs/api/id/181/aid/864" title="违章记录查询">2.违章记录查询</a>
                                                 ...
                                                 <li >
                            <a class="selected" href="/docs/api/id/181/aid/865" title="计算缴费费用">3.计算缴费费用</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/getFee.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/getFee.php?recordIds=9072200&amp;key=你申请的key</span></div>
                        ...
                        <div class="simpleline simpleTable">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>能否处理该违章，如果选择多条违章记录里面包含不能处理的违章，这里也会返回false </td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    ...
                                    <td>服务费</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">juheservice_fee</td>
                                    <td class="url">float</td>
                                    <td>聚合服务收费</td>
                                  </tr>
                                                                    <tr>
                                    ...
                                    <td>罚款金额</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">errorMsg</td>
                                    <td class="url">String</td>
                                    <td>错误信息，当违章不能处理时的错误信息</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url"></td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878715" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878715</a></td>
                            </tr>
                        </table>
                    </div>
