...
<head>
<meta charset="utf-8">
<meta name="keywords" content="违章代缴数据接口,API数据调用" />
...
<title>违章代缴数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a181.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">181</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">1031</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请违章代缴 API" data="/myData/apply/id/181">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/181" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="181"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a  href="/docs/api/id/181" title="违章城市列表">1.违章城市列表</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/864" title="违章记录查询">2.违章记录查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/865" title="计算缴费费用">3.计算缴费费用</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/866" title="提交缴费订单">4.提交缴费订单</a>
                        </li>
                                                 <li >
                            <a class="selected" href="/docs/api/id/181/aid/867" title="查询订单详情">5.查询订单详情</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/868" title="证件和罚单图片上传">6.证件和罚单图片上传</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/869" title="订单支付">7.订单支付</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/870" title="订单状态查询">8.订单状态查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/871" title="提交证件信息">9.提交证件信息</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/873" title="订单列表查询">10.订单列表查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/875" title="罚单收费单位配置">11.罚单收费单位配置</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/878" title="获取罚单信息">12.获取罚单信息</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/880" title="提交罚单订单">13.提交罚单订单</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/181/aid/881" title="配置回调地址">14.配置回调地址</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/orderDetail.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/daijiao/weizhang/orderDetail.php?orderId=699710&amp;key=您申请的key</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">注意:1.订单状态流转到已审核之前,都可以补全或者修改证件资料.2.订单一旦审核通过,不能或者不再需要上传证件资料.3.部分地区可能配置更新不及时,是否需要上传资料,以订单审核状态为准.如果未上传标记的证件,但是订单已经审核通过,说明不需要该资料了,如果标记了原本不需要上传的资料,请按要求上传</font></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>你申请的key</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">orderId</td>
                                    <td class="url">long</td>
                                    <td class="url">是</td>
                                    <td>订单ID</td>
                                  </tr>
                                                                    <tr>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>订单id</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">orderNum</td>
                                    <td class="url">String</td>
                                    <td>订单号</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">amount</td>
                                    <td class="url">float</td>
                                    <td>订单金额</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">status</td>
                                    <td class="url">int</td>
                                    <td>订单状态(参考订单状态查询接口)</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">orderTime</td>
                                    <td class="url">String</td>
                                    <td>下单时间</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">content</td>
                                    <td class="url">String</td>
                                    <td>订单内容</td>
                                  </tr>
                                                                    <tr>
                                    ...
                                    <td class="url">string</td>
                                    <td>(待定字段,当一个订单里面有部分违章记录处理失败的时候返回对应的违章记录Id)</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">vehicleNum</td>
                                    <td class="url">String</td>
                                    <td>车牌号</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">serviceCharge</td>
                                    <td class="url">float</td>
                                    <td>服务费</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">fines</td>
                                    <td class="url">float</td>
                                    <td>罚款金额</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">requiredCartInfo</td>
                                    <td class="url">String</td>
                                    <td>需要用户提交的证件信息,内容为四位字符串，第1位行驶证，第2位驾驶证，第3位身份证，第4位车主姓名。如"0101"，0不需要，非0需要。</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">againsts</td>
                                    <td class="url">JSONArray</td>
                                    <td>违章记录</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">cartInfo</td>
                                    <td class="url">JSONObject</td>
                                    <td>证件信息</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">paymentInfo</td>
                                    <td class="url">JSONObject</td>
                                    <td>支付信息</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">refundInfo</td>
                                    <td class="url">JSONObject</td>
                                    <td>退款信息</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">	JSONArray<againsts></td>
                                    <td class="url"></td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    ...
                                    <td>违章地址</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">score</td>
                                    <td class="url">int</td>
                                    <td>扣分</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">money</td>
                                    <td class="url">int</td>
                                    <td>罚款</td>
                                  </tr>
                                                                    <tr>
                                    ...
                                    <td>违章时间</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">behavior</td>
                                    <td class="url">String</td>
                                    <td>违章行为</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">	JSONObject<cartInfo></td>
                                    <td class="url"></td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">cartInfo.ownerName</td>
                                    <td class="url">String</td>
                                    <td>车主姓名</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">cartInfo.driversLicenseImageUrl</td>
                                    <td class="url">String</td>
                                    <td>行驶证图片</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">cartInfo.drivingLicenseImageUrl</td>
                                    <td class="url">String	</td>
                                    <td>驾驶证图片</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">cartInfo.cardImageUrl</td>
                                    <td class="url">String</td>
                                    <td>身份证正面图片</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">cartInfo. cardImageUrl2</td>
                                    <td class="url">String</td>
                                    <td>身份证背面图片</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">	JSONObject<paymentInfo></td>
                                    <td class="url"></td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">paymentInfo.payType</td>
                                    <td class="url">int</td>
                                    <td>支付类型(预付款类型可忽略此字段)</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">paymentInfo.money</td>
                                    <td class="url">float</td>
                                    <td>支付金额</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">paymentInfo. payTime</td>
                                    <td class="url">String</td>
                                    <td>支付时间</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">	JSONObject<refundInfo></td>
                                    <td class="url"></td>
                                    <td></td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">refundInfo. refundTime</td>
                                    <td class="url">String</td>
                                    <td>退款时间</td>
                                  </tr>
                                                                    <tr>
    ...
    &quot;result&quot;: {
        ...
        &quot;status&quot;: 2,
        &quot;fines&quot;: 200,
        &quot;requiredCartInfo&quot;: &quot;1000&quot;,
        &quot;orderNum&quot;: &quot;201603071602395861214173&quot;,
        &quot;orderTime&quot;: &quot;2016-03-07 16:02:39&quot;,
        &quot;cartInfo&quot;: null,
        &quot;refundInfo&quot;: null,
        &quot;id&quot;: 699710,
        &quot;amount&quot;: 230,
        &quot;content&quot;: &quot;1条违章: 中兴路进长兴路西约15米&quot;,
        &quot;againsts&quot;: [
            {
                &quot;id&quot;: 9072200,
                &quot;address&quot;: &quot;中兴路进长兴路西约15米&quot;,
                &quot;score&quot;: 0,
                &quot;money&quot;: 200,
                &quot;time&quot;: &quot;2016-02-28 19:15:00&quot;,
                &quot;behavior&quot;: &quot;机动车违反规定停放、临时停车且驾驶人不在现场，妨碍其它车辆、行人通行的&quot;
            }
        ],
        &quot;paymentInfo&quot;: null,
        &quot;serviceCharge&quot;: 30
    ...
    &quot;error_code&quot;: 0
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">218100</td>
                                <td class="text">网络繁忙,请稍后重试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218101</td>
                                <td class="text">服务器正在异步处理请求数据，请稍后重新获取</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218102</td>
                                <td class="text">数据源服务器未知错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218103</td>
                                <td class="text">数据源服务器繁忙</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218104</td>
                                <td class="text">聚合在供应商的账户余额不足,请联系聚合技术或客服</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218105</td>
                                <td class="text">参数不能为空或缺少必要参数</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218106</td>
                                <td class="text">订单号不存在,请核对后再试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218107</td>
                                <td class="text">文件类型不正确</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218108</td>
                                <td class="text">文件过大</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218109</td>
                                <td class="text">文件上传失败</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218110</td>
                                <td class="text">图片地址不存在</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218111</td>
                                <td class="text">聚合扣款失败信息</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218112</td>
                                <td class="text">支付第三方失败</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218113</td>
                                <td class="text">聚合返款失败,请联系客服</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218114</td>
                                <td class="text">聚合账户余额不足</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218115</td>
                                <td class="text">网络请求错误,支付失败</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218116</td>
                                <td class="text">请核对缴费资费后再提交订单</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218117</td>
                                <td class="text">不支持线上处理此违章</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218118</td>
                                <td class="text">不是合法地址</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">218119</td>
                                <td class="text">违章查询相关错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <th>说明</th>
                                                                  ...
                                                                  <tr>
                                    <td >&nbsp;</td>
                                    <td class="url" width="200">违章查询次数包</td>
                                    <td class="url" width="200">￥399.00&nbsp;&nbsp;</td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878724" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878724</a></td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>时间</th>
                                                        ...
                                                        <tr>
                                <td>&nbsp;</td>
                                <td><a href="/news/index/id/170" target="_blank">违章代缴API、城市尾号限行API上线了</a></td>
                                <td class="url">2015-08-07 13:44:42</td>
                            </tr>
                                                    </table>
                    </div>
                </div> -->
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/181" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/182"><img src="/themes/images/data/new/a182.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/182">尾号限行</a></p>
                    <p class="apides">目前支持北京、天津、兰州、杭州、长春、南昌、成都、贵阳</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/71"><img src="/themes/images/data/new/a71.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/71">二手车价值评估</a></p>
                    <p class="apides">权威公正准确的全国二手车估值</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/181"><img src="/themes/images/data/new/a181.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/181">违章代缴</a></p>
                    <p class="apides">足不出户，办理违章代缴业务，更多城市陆续上线</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/195"><img src="/themes/images/data/new/a195.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/195">车辆故障码DTC查询</a></p>
                    <p class="apides">查询车辆故障码，包括故障位置、故障描述、造成影响、和解决建议</p>
                </li>
                            </ul>
