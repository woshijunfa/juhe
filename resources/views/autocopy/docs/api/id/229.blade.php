...
<head>
<meta charset="utf-8">
<meta name="keywords" content="快递在线下单数据接口,API数据调用" />
...
<title>快递在线下单数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a229.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <p class="doc_api_decsP">应用场景：普通用户在线向快递公司在线下单，快递公司收到申请快递员上门取件</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">229</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">191</font></p>
                        ...
                        <div class="doc_arguments docPrice">
                                    ...
                                    /5000次</span>
                                                                        <span style="color: #f0767f;">（申请即送500次）</span>
                                                                    </p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请快递在线下单 API" data="/myData/apply/id/229">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/229" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="229"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/229" title="获取快递公司列表">1.获取快递公司列表</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/229/aid/853" title="在线下单发快递">2.在线下单发快递</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/229/aid/854" title="撤销订单">3.撤销订单</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/229/aid/855" title="推送接口设置">4.推送接口设置</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/expressonline/test/getCarriers.php</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/expressonline/test/getCarriers.php?key=APPKEY</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">获取支持的快递公司列表</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/229" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>您申请的appkey</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">ex_category</td>
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>all: 全部快递公司; recommend:推荐快递公司; agreement 协议快递公司;(默认是all)</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
    ...
    &quot;result&quot;: [
        {
            &quot;carrier_code&quot;: &quot;ems&quot;,<font color='red'>/*快递公司代码*/</font>
            &quot;carrier_phone&quot;: &quot;11183&quot;,<font color='red'>/*快递公司电话*/</font>
            &quot;carrier_name&quot;: &quot;EMS&quot;<font color='red'>/*快递公司名称*/</font>
        },
        {
...
&lt;/root&gt;</pre>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">222900</td>
                                <td class="text">系统错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">222901</td>
                                <td class="text">参数错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">222902</td>
                                <td class="text">数据错误</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">222903</td>
                                <td class="text">订单号已存在</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">222904</td>
                                <td class="text">订单号不存在</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">222905</td>
                                <td class="text">该订单下单失败无需撤销</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">222906</td>
                                <td class="text">该订单已撤销成功</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">222907</td>
                                <td class="text">订单状态不属于下单成功和撤单失败,无法继续进行撤销</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                      </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878640" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878640</a></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/229" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/66"><img src="/themes/images/data/new/a66.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/66">邮编查询</a></p>
                    <p class="apides">提供全国邮政编码大全,为你快速准确查邮编</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/137"><img src="/themes/images/data/new/a137.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/137">商品比价</a></p>
                    <p class="apides">汇集了所有主流网上商城的报价、促销、抢购、团购信息</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/43"><img src="/themes/images/data/new/a43.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/43">常用快递</a></p>
                    <p class="apides">支持顺丰、EMS、申通、圆通、韵达、汇通、中通、天天、德邦、全峰等主流快递公司。</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/235"><img src="/themes/images/data/new/a235.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/235">新闻头条</a></p>
                    <p class="apides">最新新闻头条，各类社会、国内、国际、体育、娱乐、科技等资讯，更新周期5-30分钟</p>
                </li>
                            </ul>
