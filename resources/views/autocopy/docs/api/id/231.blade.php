        ...
        <div id="docs_api_main">
            <div class="api_data">
                ...
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        ...
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">605</font></p>
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/231" title="商品列表">1.商品列表</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/231/aid/860" title="发货">2.发货</a>
                        </li>
                                                 <li >
                    ...
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/giftCard/products</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/giftCard/products</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">查询可购买的礼品卡的列表，及每个礼品卡对应的productId。如需了解各礼品卡的使用，请点击 <a href="http://code.juhe.cn/docs/1944" target="_blank">我</a></font></div>
                        ...
                        <div class="simpleline simpleTable">
                            ...
                            <b>JSON返回示例：</b>
                            <div class="prediv">
                                <pre><font color='red'>/* 示例内容有所省略，请以您取到的最新数据为准 */</font>
<font color='red'>/* 商品ID基本不会变，请做好长期的缓存 */</font>
<font color='green'>/* 如果您的需求量较大，请告诉我们您需要的卡种以便我们备货 */</font>
<font color='green'>/* 如需各卡的使用说明，请访问 http://code.juhe.cn/docs/1944 */</font>

{
  &quot;reason&quot;: &quot;查询成功&quot;,
  &quot;result&quot;: [
    {
      &quot;productId&quot;: &quot;100026&quot;, <font color='red'>/* 商品ID基本不会变，请做好长期的缓存 */</font>
      &quot;name&quot;: &quot;携程任我行100元&quot;, <font color='red'>/* 商品名 */</font>
      &quot;value&quot;: &quot;100.00&quot;, <font color='red'>/* 商品面值 */</font>
      &quot;discount&quot;: &quot;0.998&quot; <font color='red'>/* 默认折扣，如您需求量较大，可议 */</font>
    },
    {
      &quot;productId&quot;: &quot;100027&quot;,
      &quot;name&quot;: &quot;携程任我行500元&quot;,
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878636" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878636</a></td>
                            </tr>
                        </table>
                    </div>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">支持指定城市社保公积金缴费比例查询和补缴计算、正常缴纳以及补缴，测试完毕后请联系商务获取正式生产环境接口。服务费：请咨询客服</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/105"><img src="/themes/images/data/new/a105.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/105">流量直充</a></p>
                    <p class="apides">依据用户提供的请求为指定手机充值流量</p>
                </li>
                                <li>
                    ...
                    <p class="apides">苹果app游戏在线直充</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/88"><img src="/themes/images/data/new/a88.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/88">游戏充值</a></p>
