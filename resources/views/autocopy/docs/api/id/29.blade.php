...
<head>
<meta charset="utf-8">
<meta name="keywords" content="黄金数据数据接口,API数据调用" />
...
<title>黄金数据数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a29.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    <h2><strong>黄金数据</strong>
                                                <span class="h1_span color_juhe">聚合数据</span>
                        
                        <span class="h1_span color_mianfei">免费</span>                                                
                                            </h2>
                    <p class="doc_api_decsP">黄金品种、最新价、开盘价、最高价等信息</p>
					<!--五周年活动 start-->
                    					<!--五周年活动 end-->
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">29</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">2270</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请黄金数据 API" data="/myData/apply/id/29">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/29" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="29"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/29" title="上海黄金交易所">1.上海黄金交易所</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/29/aid/60" title="上海期货交易所">2.上海期货交易所</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/29/aid/61" title="银行账户黄金">3.银行账户黄金</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://web.juhe.cn:8080/finance/gold/shgold</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://web.juhe.cn:8080/finance/gold/shgold?key=您申请的APPKEY</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">周末市场没有开放，故周末无数据</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/29" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">String</td>
                                    <td class="url">否</td>
                                    <td>JSON格式版本(0或1)默认为0,建议使用格式1</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
	...
	{
		&quot;1&quot;:{
			&quot;variety&quot;:&quot;Ag(T+D)&quot;,		<font color='red'>/*品种*/</font>
			&quot;latestpri&quot;:&quot;6585.00&quot;,		<font color='red'>/*最新价*/</font>
			&quot;openpri&quot;:&quot;6712.00&quot;,		<font color='red'>/*开盘价*/</font>
			&quot;maxpri&quot;:&quot;6721.00&quot;,		<font color='red'>/*最高价*/</font>
			&quot;minpri&quot;:&quot;6581.00&quot;,		<font color='red'>/*最低价*/</font>
			&quot;limit&quot;:&quot;-1.98%&quot;,		<font color='red'>/*涨跌幅*/</font>
			&quot;yespri&quot;:&quot;6718.00&quot;,		<font color='red'>/*昨收价*/</font>
			&quot;totalvol&quot;:&quot;1564524.0000&quot;,	<font color='red'>/*总成交量*/</font>
			&quot;time&quot;:&quot;2012-12-19 15:29:59&quot;	<font color='red'>/*更新时间*/</font>
		},
		...... 
		&quot;2&quot;:{
			&quot;variety&quot;:&quot;Au(T+D)&quot;,
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">202901</td>
                                <td class="text">查询不到结果</td>
                                <!--<td class="url">201</td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">202902</td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/29" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/213"><img src="/themes/images/data/new/a213.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/213">银行卡四元素校验</a></p>
                    <p class="apides">检测输入的姓名、手机号码、身份证号码、银行卡号是否一致。</p>
                </li>
                                <li>
                    ...
                    <p class="apides">检测输入的姓名、银行卡号是否一致。</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/192"><img src="/themes/images/data/new/a192.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/192">企业工商信息</a></p>
                    <p class="apides">根据企业名称或营业执照编号查询企业基本工商信息。</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/28"><img src="/themes/images/data/new/a28.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/28">基金财务数据</a></p>
                    <p class="apides">基金财务数据</p>
                </li>
                            </ul>
