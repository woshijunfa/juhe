...
<head>
<meta charset="utf-8">
<meta name="keywords" content="身份证头像验证数据接口,API数据调用" />
...
<title>身份证头像验证数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a199.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">199</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">639</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请身份证头像验证 API" data="/myData/apply/id/199">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/199" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="199"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/199" title="身份证头像验证">1.身份证头像验证</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/idcardhead/query</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/idcardhead/query</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">通过真实姓名和身份证件号码，获取身份证头像照片的经过Base64编码</font></div>
                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/199" target="_blank">API测试工具</a></div>
    ...
    &quot;reason&quot;: &quot;查询成功&quot;,
    &quot;result&quot;: {
        &quot;jobid&quot;: &quot;2016012715204690375&quot;,
        &quot;realname&quot;: &quot;张丹丹&quot;,
        &quot;idcard&quot;: &quot;410724198506255521&quot;,
        &quot;res&quot;: &quot;1&quot;,<font color='red'>结果：1:一致 2:不一致 3:无此身份证号码</font>
        &quot;message&quot;: &quot;一致&quot;,
        &quot;headimg&quot;: &quot;头像图片base64串&quot;<font color='red'>头像图片base64串，使用方法比如：&lt;img 
src=&quot;data:image/jpg;base64,/9j/4AAQSkZJRgABAgAAAQABAA...&quot;&gt;</font>
    },
    &quot;error_code&quot;: 0
}</pre>
                            </div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">219901</td>
                                <td class="text">无效的身份证</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">219902</td>
                                <td class="text">身份证姓名不合法</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">219903</td>
                                <td class="text">身份证号码不合法</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">219904</td>
                                <td class="text">系统异常</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">219905</td>
                ...
                <div class="docs_api_show">
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="url" width="200">￥1799.00&nbsp;&nbsp;</td>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467878701" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467878701</a></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/199" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
