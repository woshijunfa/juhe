...
<head>
<meta charset="utf-8">
<meta name="keywords" content="NBA赛事数据接口,API数据调用" />
...
<title>NBA赛事数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a92.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">92</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">2982</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请NBA赛事 API" data="/myData/apply/id/92">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/92" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="92"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/92" title="NBA常规赛赛程赛果">1.NBA常规赛赛程赛果</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/92/aid/247" title="球队赛程赛事查询">2.球队赛程赛事查询</a>
                        </li>
                                                 <li >
                            <a  href="/docs/api/id/92/aid/248" title="球队对战赛赛程查询">3.球队对战赛赛程查询</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://op.shareapi.com/onebox/basketball/nba</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://op.shareapi.com/onebox/basketball/nba?key=您申请的KEY</span></div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>说明</th>
                                                          ...
                                                          <tr>
                                <td >&nbsp;</td>
                                <td class="url">209201</td>
                                <td class="text">球队名称不能为空</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">209202</td>
                                <td class="text">查询不到NBA相关信息</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">209203</td>
                                <td class="text">网络错误。请重试</td>
                                <!--<td class="url"></td>-->
                              </tr>
                                                            <tr>
                                <td >&nbsp;</td>
                                <td class="url">209204</td>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>时间</th>
                                                        ...
                                                        <tr>
                                <td>&nbsp;</td>
                                <td><a href="/news/index/id/117" target="_blank">NBA赛事接口上线</a></td>
                                <td class="url">2014-12-08 09:42:37</td>
                            </tr>
                                                    </table>
                    </div>
                </div> -->
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                    ...
                    <p class="apides">根据经纬度及体育馆类型查询场馆信息</p>
                                ...
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/90"><img src="/themes/images/data/new/a90.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/90">足球联赛</a></p>
                    <p class="apides">目前支持 英超，西甲，德甲，意甲，法甲，中超等赛事</p>
                </li>
                                <li>
