...
<head>
<meta charset="utf-8">
<meta name="keywords" content="新闻头条数据接口,API数据调用" />
...
<title>新闻头条数据接口_免费API接口调用-分享数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a235.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">235</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">1042</font></p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <a class="api_newbtn_apply" href="javascript:xlogin();" title="申请新闻头条 API" data="/myData/apply/id/235">申请数据</a>
                        
                        
                        
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/235" target="_blank">离线文档</a> -->
                    </div>
                </div>
                
                                  <a class="unfavit" id="favita" data="235"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/235" title="新闻类接口">1.新闻类接口</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.shareapi.com/toutiao/index</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.shareapi.com/toutiao/index?type=top&amp;key=APPKEY</span></div>

                                                <div class="simpleline"><strong>接口备注：</strong><font color="">返回头条，社会，国内，娱乐，体育，军事，科技，财经，时尚等新闻信息</font></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td class="url">string</td>
                                    <td class="url">否</td>
                                    <td>类型,,top(头条，默认),shehui(社会),guonei(国内),guoji(国际),yule(娱乐),tiyu(体育)junshi(军事),keji(科技),caijing(财经),shishang(时尚)</td>
                                  </tr>
                                                              </table>
                        </div>
                        <div class="simpleline simpleTable">
    ...
    &quot;result&quot;: {
        ...
        &quot;data&quot;: [
            {
                &quot;title&quot;: &quot;巫山云雨枉断肠：女摄影师Erika Lust记录的性爱&quot;,<font color='red'>/*标题*/</font>
                &quot;date&quot;: &quot;2016-06-13 10:31&quot;,<font color='red'>/*时间*/</font>
                &quot;author_name&quot;: &quot;POCO摄影&quot;,<font color='red'>/*作者*/</font>
                &quot;thumbnail_pic_s&quot;: &quot;http://09.imgmini.eastday.com/mobile/20160613/20160613103108_7b015493398e7fd13dda3a5c
e315b1c8_1_mwpm_03200403.jpeg&quot;,<font color='red'>/*图片1*/</font>
                &quot;thumbnail_pic_s02&quot;: &quot;http://09.imgmini.eastday.com/mobile/20160613/20160613103108_7b015493398e7fd13dda3a5ce315
b1c8_1_mwpl_05500201.jpeg&quot;,<font color='red'>/*图片2*/</font>
                &quot;thumbnail_pic_s03&quot;: &quot;http://09.imgmini.eastday.com/mobile/20160613/20160613103108_7b015493398e7fd13dda3a5ce315
b1c8_1_mwpl_05500201.jpeg&quot;,<font color='red'>/*图片3*/</font>
                &quot;url&quot;: &quot;http://mini.eastday.com/mobile/160613103108379.html?qid=juheshuju&quot;,<font color='red'>/*新闻链接*/</font>
                &quot;uniquekey&quot;: &quot;160613103108379&quot;,<font color='red'>/*唯一标识*/</font>
                &quot;type&quot;: &quot;头条&quot;,<font color='red'>/*类型一*/</font>
                &quot;realtype&quot;: &quot;娱乐&quot;<font color='red'>/*类型二*/</font>
            },
...]}}</pre>
                            </div>
                        </div>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/212"><img src="/themes/images/data/new/a212.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/212">ISBN数据查询</a></p>
                    <p class="apides">通过请求10位或13位的ISBN码可以反馈给用户相应的书籍信息和推荐指数</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/177"><img src="/themes/images/data/new/a177.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/177">万年历</a></p>
                    <p class="apides"></p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/45"><img src="/themes/images/data/new/a45.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/45">餐饮美食</a></p>
                    <p class="apides">提供周边美食餐厅检索</p>
                </li>
                                <li>
