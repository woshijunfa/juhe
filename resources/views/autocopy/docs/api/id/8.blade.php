...
<head>
<meta charset="utf-8">
<meta name="keywords" content="移动联通基站数据接口,API数据调用" />
...
<title>移动联通基站数据接口_免费API接口调用-聚合数据</title>
...
<header class="width100_v4">
    ...
    <div id="docsapiContent" class="clearfix">
        <div id="docs_api_main">
            <div class="api_data">
                <div class="api_data_img png_bg" style="background:url(/themes/images/data/new/a8.png) center no-repeat;">
                	<!--五周年活动 icon-->
                		                	<!--五周年活动 icon end-->
                </div>
                <div class="api_data_info">
                    ...
                    <div id="api_arguments" class="clearfix">
                        <div class="doc_arguments">
                            <p><b>数据ID：</b><font color="#ff9445">8</font></p>
                            <p><b>接口状态：</b><font color="#88c773"><span style="color:#88c773; ">正常</span></font></p>
                        </div>
                        <div class="doc_arguments">
                            <p><b>连接应用数：</b><font color="#777">39978</font></p>
                        ...
                        <div class="doc_arguments docPrice">
                                    ...
                                    /20000次</span>
                                                                        <span style="color: #f0767f;">（申请即送1000次）</span>
                                                                    </p>
                    ...
                    <div class="api_data_btns">
                        ...
                        <!-- <a class="api_newbtn_pdf" href="/docs/demo/id/8" target="_blank">离线文档</a> -->
                                  ...
                                  <a class="unfavit" id="favita" data="8"></a>
                                <!--  -->
            ...
            <div class="tabDiv">
                ...
                <div style="padding-left: 0;" class="docs_api_show clearfix">
                    <ul class="das_left">
                                                 <li class="clearfix">
                            <a class="selected" href="/docs/api/id/8" title="基站定位">1.基站定位</a>
                        </li>
                                            </ul>
                    <div class="das_right">
                        <div class="simpleline"><strong>接口地址：</strong><span class="url">http://v.juhe.cn/cell/get</span></div>
                        ...
                        <div class="simpleline"><strong>请求示例：</strong><span class="url">http://v.juhe.cn/cell/get?mnc=0&cell=28655&lac=17695&key=您申请的APPKEY</span></div>

                        
                                                <div class="simpleline"><strong>调用样例及调试工具：</strong><a class="api_test_tools" href="/box/index/id/8" target="_blank">API测试工具</a></div>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <th>说明</th>
                                                                  ...
                                                                  <tr>
                                    <td>&nbsp;</td>
                                    <td class="url"><font color=red>mnc</font></td>
                                    <td class="url"><font color=red>int<font color=red></td>
                                    <td class="url"><font color=red>是</font></td>
                                    <td><font color=red>移动基站：0 联通基站:1  默认:0</font></td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">lac</td>
                            ...
                            <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    ...
                                    <td>纬度</td>
                                                                    ...
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">　　O_LNG</td>
                                    <td class="url">string</td>
                                    <td>纠偏后的经度（用于google地图显示）</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">　　O_LAT</td>
                                    <td class="url">string</td>
                                    <td>纠偏后的纬度（用于google地图显示）</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
                                    <td class="url">　　PRECISION</td>
                                    <td class="url">string</td>
                                    <td>基站信号覆盖范围（单位：米，半径）</td>
                                  </tr>
                                                                    <tr>
                                    <td>&nbsp;</td>
...
&lt;/root&gt;</pre>
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table id="code_table" class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="url"><a href="http://www.juhe.cn/qa/index/1467876445" class="blue" target="_blank">http://www.juhe.cn/qa/index/1467876445</a></td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <th>时间</th>
                                                        ...
                                                        <tr>
                                <td>&nbsp;</td>
                                <td><a href="/news/index/id/76" target="_blank">基站查询手机网页版上线</a></td>
                                <td class="url">2014-07-27 15:49:15</td>
                            </tr>
                                                    </table>
                    </div>
                </div> -->
                    ...
                    <div class="simpleline simpleTable">
                        ...
                        <table class="api_table" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="text"><a href="/box/index/id/8" class="blue" target="_blank">API测试工具</a></td>
                            </tr>
                            <tr>
                                <td >&nbsp;</td>
        ...
        <div id="doc_api_right">
            ...
            <ul class="tuijianapi">
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/32"><img src="/themes/images/data/new/a32.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/32">地图坐标服务</a></p>
                    <p class="apides">支持百度、谷歌、GPS三大经纬度互相转化</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/16"><img src="/themes/images/data/new/a16.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/16">电信基站</a></p>
                    <p class="apides">通过电信基站的系统识别码、网络识别码和基站号进行基站位置查询。</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/8"><img src="/themes/images/data/new/a8.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/8">移动联通基站</a></p>
                    <p class="apides">通过移动联通基站的小区号和基站号进行基站位置查询。</p>
                </li>
                                <li>
                    <a class="tuijianimg" href="/docs/api/id/15"><img src="/themes/images/data/new/a15.png" /></a>
                    <p class="apiname"><a href="/docs/api/id/15">经纬度地址解析</a></p>
