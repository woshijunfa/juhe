...
<head>
    <meta charset="utf-8">
    <meta name="keywords" content="爱奇艺会员卡数据接口,API数据调用" />
    ...
    <title>爱奇艺会员卡_礼品卡介绍_免费API接口调用-分享数据</title>
...
<div id="docsapiContent" class="clearfix">
    <div id="docs_api_main">
        <div class="api_data">
            <div class="api_data_img png_bg" style="background:url(/themes/v4/public/images/giftcard/17.png) center no-repeat;">
            ...
            <div class="api_data_info">
                ...
                <p class="doc_api_decsP">爱奇艺黄金会员卡，5周年活动底价首发：7天卡-9元/张，月卡仅需17元/张，季卡-49元/张，半年卡-90元/张，年卡-168元/张！</p>
                <div id="api_arguments" class="clearfix">
                    ...
                    <div class="doc_arguments">
                        <p><b>礼品卡类型：</b><font color="#777">虚拟卡</font></p>
                ...
                <div class="api_data_btns">
                     <a class="api_newbtn_apply" href="/docs/api/id/231" target="_blank">查看礼品卡API文档</a>
                     &nbsp;&nbsp;<a style="background: #ff3d62; color: #fff;" rel="nofollow" href="http://crm2.qq.com/page/portalpage/wpa.php?uin=800076065&amp;f=1&amp;ty=1&amp;aty=0&amp;a=&amp;from=6" target="_blank">更多折扣联系客服</a>
                </div>
            </div>
        ...
        <div class="docs_api_tab">
            <ul class="tabul clearfix">
                ...
                <li id="apiprice">使用说明</li>
                <li id="apiprice">价格说明</li>

                <!--<li id="sdkandqa">示例代码</li>-->
                <!-- <li id="update">更新记录</li> -->
                <li id="apicontact">其他信息</li>
            </ul>
        </div>
        <div class="tabDiv">
            <!--api-->
            <div style="padding-left: 20px; line-height: 25px; color: #666; font-size:12px" class="docs_api_show clearfix">
                <img src="/themes/v4/public/images/giftcard/giftstep.png" border="0">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="api_table">
                        <tr class="title">
                            ...
                            <td>&nbsp;</td>
                                                ...
                                                <tr>
                            <td >&nbsp;</td>
                            <td class="text" colspan="4">更多礼品卡种类、价格请参照商品列表接口或咨询客服</td>
                        </tr>
                        
                        <tr>
                            <td >&nbsp;</td>
                            <td class="text" colspan="4" style="color:red">部分礼品卡有官方发卡规则限制，如有大批量采购需求，请联系客服，客服电话：400-882-7715；卡密一经售出，非卡密本身质量原因，概不退换</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div id="doc_api_right">
        ...
        <ul class="tuijianapi">
                ...
                <p class="apides">足不出户，办理违章代缴业务，更多城市陆续上线</p>
                        ...
                        <li>
                <a class="tuijianimg" href="/docs/api/id/124"><img src="/themes/images/data/new/a124.png" /></a>
                <p class="apiname"><a href="/docs/api/id/124">信鸽推送</a></p>
                <p class="apides">腾讯信鸽推送是免费专业的移动推送平台，为安卓和iOS的APP提供推送服务</p>
            </li>
                        <li>
