...
<link rel="stylesheet" type="text/css" href="/themes/v4/public/css/search.css"/>
<title>搜你所要_免费数据调用接口-分享数据</title>
...
<style>
.tool_float{
    height:160px; width:50px; position:fixed; _position:absolute; top:80%; right:0px;  z-index:99;
}
.tool_float:hover{}

.tool_float .tool_kf{ width:50px; display:block; height:50px; background:url(/themes/images/float.png) center  -55px no-repeat; margin-bottom:2px;}
.tool_float .tool_kf:hover{background:url(/themes/images/floath.png) center  -55px no-repeat;}
.tool_float .tool_feed{ width:50px; display:block; height:50px; background:url(/themes/images/float.png) center  -110px no-repeat; }
.tool_float .tool_feed:hover{background:url(/themes/images/floath.png) center  -110px no-repe}
.tool_float .tool_top{ width:50px; display:block; height:50px; background:url(/themes/images/float.png) center  top no-repeat;}
</style>
</head>
<body>
...
<header class="width100_v4">
    ...
    <div class="tool_float">
        <a class="tool_kf" title="联系在线客服" rel="nofollow"  href="http://wpa.qq.com/msgrd?v=3&uin=1794844675&site=qq&menu=yes" target="_blank"></a>
    </div>
    ...
    <div id="docs-main">
        ...
        <div id="main">
            <div class="data_title">
                <div class="title" id="data_index">
                    <div style="width:250px; overflow:hidden; height:30px; background:url(/themes/images/data/i/s.png) left center no-repeat; text-indent:30px; margin-bottom:20px;">检索结果</div>
                </div>
                                    ...
                                    <div class="juhedata_v4 hotData_v4">
                                        <ul class="clearfix">
                                                ...
                                                <div class="dataDes_v4">
                                                    ...
                                                    <p>已连接APP：<span>39987</span></p>
                                                </div>
                                            </li>
                                                                                    <li>
                                                <div class="dataDiv_v4"><a href="/docs/api/id/16" title="电信基站"><img class="png_bg" src="/themes/images/data/new/a16.png" alt="电信基站" /></a></div>
                                                <div class="dataDes_v4">
                                                    <div class="dataTitle_v4">电信基站</div>
                                                    <p>已连接APP：<span>10532</span></p>
                                                </div>
                                            </li>
                                                                                </ul>
                                    </div>
