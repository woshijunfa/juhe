...
<header class="width100_v4">
    ...
    <div class="pricemain">
        ...
        欢迎阅读聚合云数据开放平台（以下简称聚合）的隐私权保护规则。聚合视对平台用户隐私的保护，保护隐私是聚合的一项基本政策。本隐私声明解释了这些情况下的数据收集和使用情况。 本隐私政策适用于聚合的所有相关服务，随着聚合服务的变动或扩展，隐私声明的内容可由聚合随时更新，且毋须另行通知。更新后的隐私声明一旦在网页上公布即有效代替原来的隐私声明。
            </div>
            <div class="content-title" >1、我们收集哪些信息</div>
            <div class=" linestyle" >一般情况下，用户可以匿名访问聚合网站查看相关的服务文档。当我们需要能识别您的个人信息或者可以与您联系的信息时，我们会征求您的同意。
            但在注册聚合或申请聚合某项服务时，我们可能会收集这些信息:手机号码、Email地址，并征求你的确认。
            </div>

            <div class="content-title" >2、关于您的个人信息</div>
            <div class=" linestyle" >聚合严格保护您个人信息的安全。我们使用各种安全技术和程序来保护您的个人信息不被未经授权的访问、使用或泄漏。聚合会在法律要求或符合聚合的相关服务条款协议约定的情况下透露您的个人信息，或者有充分理由相信必须这样做才能：
    　　      </div>
            <div class=" linestyle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（1）满足法律或行政法规的明文规定，或者符合聚合网站适用的法律程序；；</div>
            <div class=" linestyle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（2）符合聚合相关服务条款、软件许可使用协议的约定；</div>
            <div class=" linestyle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（3）保护聚合的权利或财产，以及在紧急情况下保护聚合员工、聚合产品或服务的用户或大众的个人安全；</div>
            <div class=" linestyle" >聚合不会未经您的允许将这些信息与第三方共享，本声明已经列出的上述情况除外</div>

            <div class="content-title" >3、 Cookie的使用</div>
            <div class="linestyle">您了解并同意，聚合使用cookie来使聚合网站对用户更友好，它可以帮您省去为使用我们的服务而重复输入注册信息和跟踪您的浏览器的状态。如果您的浏览器允许，您可以拒绝聚合的"Cookies" 。</div>


            <div class="content-title" >4、关于免责说明</div>
            <div class="linestyle">就下列相关事宜的发生，聚合不承担任何法律责任：</div>
            <div class=" linestyle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（1）由于您将用户密码告知他人或与他人共享注册帐户，由此导致的任何个人信息的泄漏，或其他非因聚合原因导致的个人信息的泄漏；</div>
            <div class=" linestyle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（2）聚合根据法律规定或政府相关政策要求提供您的个人信息；</div>
            <div class=" linestyle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（3）任何第三方根据聚合各服务条款及声明中所列明的情况使用您的个人信息，由此所产生的纠纷；</div>
            <div class=" linestyle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（4）任何由于黑客攻击、电脑病毒侵入或政府管制而造成的暂时性网站关闭；</div>
            <div class=" linestyle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（5）因不可抗力导致的任何后果；</div>
            <div class=" linestyle" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（6）聚合在各服务条款及声明中列明的使用方式或免责情形；</div>
